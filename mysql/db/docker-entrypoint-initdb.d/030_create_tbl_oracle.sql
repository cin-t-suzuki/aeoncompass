USE ac_travel;
  ...
  ;
   ...
   ALTER TABLE `additional_zengin`  COMMENT '引落追加額データ;口座振替の引落額に、前月の積残し分などの追加額を上乗せする';
  ...
  ;
   ...
   ALTER TABLE `affiliater`  COMMENT 'アフィリエイター;';
--   *** ------------------------------------
--  *** FILIATE_PROGRAM
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `affiliate_program`  COMMENT 'アフィリエイトプログラム;';
--   *** ------------------------------------
--  *** AFU_CANCEL_QUEUE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `akafu_cancel_queue`  COMMENT '赤い風船在庫戻しリカバリ;予約キャンセル時失敗データをキューにためて再処理を行う。';
--   *** ------------------------------------
--  *** AFU_STOCK_FRAME_NO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `akafu_stock_frame_no`  COMMENT '赤い風船在庫枠番号;';
--   *** ------------------------------------
--  *** F_STOCK_FRAME_NO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `akf_stock_frame_no`  COMMENT '赤い風船在庫枠番号;';
--   *** ------------------------------------
--  *** ERT_MAIL_HOTEL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `alert_mail_hotel`  COMMENT 'アラートメール施設;社内への通知メール情報を保持します';
--   *** ------------------------------------
--  *** ERT_MAIL_OPC
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `alert_mail_opc`  COMMENT 'アラートメールOPC;社内への通知メール情報を保持します。';
--   *** ------------------------------------
--  *** ERT_POST
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `alert_post`  COMMENT 'アラート担当者;社内での担当者情報を保持します';
--   *** ------------------------------------
--  *** ERT_SYSTEM
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `alert_system`  COMMENT 'アラートシステム;アラート機能を必要とするシステムを定義';
--   *** ------------------------------------
--  *** ERT_VACANT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `alert_vacant`  COMMENT '空室アラート;';
--   *** ------------------------------------
--  *** EA_YDP_MATCH
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `area_ydp_match`  COMMENT '地域リダイレクトマッチ;';
--   *** ------------------------------------
--  *** LLPAYED_CREDIT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_credit`  COMMENT '宿泊別請求支払赤伝票（カード決済）;';
--   *** ------------------------------------
--  *** LLPAYED_CREDIT_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_credit_9xg`  COMMENT '宿泊別請求支払赤伝票（カード決済）_テスト用;宿泊別請求支払赤伝票（カード決済）本番テスト用';
--   *** ------------------------------------
--  *** LLPAYED_FEE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_fee`  COMMENT '宿泊別請求支払赤伝票（システム利用料）;';
--   *** ------------------------------------
--  *** LLPAYED_FEE_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_fee_9xg`  COMMENT '宿泊別請求支払赤伝票（システム利用料）_テスト用;宿泊別請求支払赤伝票（システム利用料）本番テスト用';
--   *** ------------------------------------
--  *** LLPAYED_HOTEL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hotel`  COMMENT '施設別請求支払赤伝票;';
--   *** ------------------------------------
--  *** LLPAYED_HOTEL_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hotel_9xg`  COMMENT '施設別請求支払赤伝票_テスト用;施設別請求支払赤伝票本番テスト用';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hotel_credit`  COMMENT '施設別請求支払赤伝票（カード決済）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hotel_credit_9xg`  COMMENT '施設別請求支払赤伝票（カード決済）_テスト用;施設別請求支払赤伝票（カード決済）本番テスト用';
--   *** ------------------------------------
--  *** LLPAYED_HOTEL_FEE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hotel_fee`  COMMENT '施設別請求支払赤伝票（システム利用料）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hotel_fee_9xg`  COMMENT '施設別請求支払赤伝票（システム利用料）_テスト用;施設別請求支払赤伝票（システム利用料）本番テスト用';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hotel_grants`  COMMENT '施設別請求支払赤伝票(補助金);';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hotel_grants_9xg`  COMMENT '施設別請求支払赤伝票(補助金)_テスト;';
--   *** ------------------------------------
--  *** LLPAYED_HOTEL_RSV
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hotel_rsv`  COMMENT '施設別請求支払赤伝票（リザーブ）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hotel_rsv_9xg`  COMMENT '施設別請求支払赤伝票（リザーブ）_テスト用;施設別請求支払赤伝票（リザーブ）本番テスト用';
--   *** ------------------------------------
--  *** LLPAYED_HOTEL_YAHOO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hotel_yahoo`  COMMENT '施設別請求支払赤伝票（ヤフー）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hotel_yahoo_9xg`  COMMENT '施設別請求支払赤伝票（ヤフー）_テスト用;施設別請求支払赤伝票（ヤフー）本番テスト用';
--   *** ------------------------------------
--  *** LLPAYED_HR_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hr_grants`  COMMENT '宿泊別請求支払赤伝票(補助金);補助金適用先への精算用';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_hr_grants_9xg`  COMMENT '宿泊別請求支払赤伝票(補助金)_テスト;';
--   *** ------------------------------------
--  *** LLPAYED_PR_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_pr_grants`  COMMENT '宿泊別赤伝(補助金);';
--   *** ------------------------------------
--  *** LLPAYED_PTN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_ptn`  COMMENT '提携先別赤伝;';
--   *** ------------------------------------
--  *** LLPAYED_PTN_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_ptn_grants`  COMMENT '提携先別赤伝票(補助金);';
--   *** ------------------------------------
--  *** LLPAYED_PTN_SALES
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_ptn_sales`  COMMENT '提携先別赤伝票（販売手数料）;';
--   *** ------------------------------------
--  *** LLPAYED_PTN_STOCK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_ptn_stock`  COMMENT '提携先別赤伝票（在庫手数料）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_ptn_type_grants`  COMMENT '	提携先補助金種類別赤伝票（補助金）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_ptn_type_sales`  COMMENT '提携先在庫タイプ赤伝票（販売手数料）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_ptn_type_stock`  COMMENT '提携先在庫タイプ別赤伝票（在庫手数料）;';
--   *** ------------------------------------
--  *** LLPAYED_RSV
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_rsv`  COMMENT '宿泊別請求支払赤伝票（リザーブ）;';
--   *** ------------------------------------
--  *** LLPAYED_RSV_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_rsv_9xg`  COMMENT '宿泊別請求支払赤伝票（リザーブ）_テスト用;宿泊別請求支払赤伝票（リザーブ）本番テスト用';
--   *** ------------------------------------
--  *** LLPAYED_SALES
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_sales`  COMMENT '宿泊別赤伝（販売手数料）;';
--   *** ------------------------------------
--  *** LLPAYED_STOCK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_stock`  COMMENT '宿泊別赤伝（在庫手数料）;';
--   *** ------------------------------------
--  *** LLPAYED_YAHOO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_yahoo`  COMMENT '宿泊別請求支払赤伝票（ヤフー）;';
--   *** ------------------------------------
--  *** LLPAYED_YAHOO_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpayed_yahoo_9xg`  COMMENT '	宿泊別請求支払赤伝票（ヤフー）_テスト用;	宿泊別請求支払赤伝票（ヤフー）本番テスト用';
--   *** ------------------------------------
--  *** LLPAY_BOOK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_book`  COMMENT '請求支払データ;';
--   *** ------------------------------------
--  *** LLPAY_BOOK_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_book_9xg`  COMMENT '請求支払データ（台帳）_テスト用;請求支払データ（台帳）_本番テスト用';
--   *** ------------------------------------
--  *** LLPAY_CREDIT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_credit`  COMMENT '宿泊別請求支払データ（カード決済）;';
--   *** ------------------------------------
--  *** LLPAY_CREDIT_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_credit_9xg`  COMMENT '宿泊別請求支払データ（カード決済）_テスト用;宿泊別請求支払データ（カード決済）本番テスト用';
--   *** ------------------------------------
--  *** LLPAY_CUSTOMER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_customer`  COMMENT '請求支払先（請求支払）;';
--   *** ------------------------------------
--  *** LLPAY_CUSTOMER_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_customer_9xg`  COMMENT '請求支払先（請求支払）_テスト用;請求支払先（請求支払）本番テスト用';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_customer_hotel`  COMMENT '請求支払先関連施設（請求支払）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_customer_hotel_9xg`  COMMENT '請求支払先関連施設（請求支払）_テスト用;請求支払先関連施設（請求支払）本番テスト用';
--   *** ------------------------------------
--  *** LLPAY_FEE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_fee`  COMMENT '宿泊別請求支払データ（システム利用料）;';
--   *** ------------------------------------
--  *** LLPAY_FEE_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_fee_9xg`  COMMENT '宿泊別請求支払データ（システム利用料）_テスト用;宿泊別請求支払データ（システム利用料）本番テスト用';
--   *** ------------------------------------
--  *** LLPAY_FEE_DRAFT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_fee_draft`  COMMENT '宿泊別仮締（広告宣伝費）;';
--   *** ------------------------------------
--  *** LLPAY_FIX
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_fix`  COMMENT '請求支払検実行用;請求支払実行開始時の検収状態を保持し精算処理を行う。';
--   *** ------------------------------------
--  *** LLPAY_FIX_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_fix_9xg`  COMMENT '請求支払検収実行用_テスト用;請求支払検収実行用本番テスト用';
--   *** ------------------------------------
--  *** LLPAY_HOTEL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hotel`  COMMENT '請求支払施設データ;';
--   *** ------------------------------------
--  *** LLPAY_HOTEL_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hotel_9xg`  COMMENT '施設別請求支払データ_テスト用;施設別請求支払データ本番テスト用';
--   *** ------------------------------------
--  *** LLPAY_HOTEL_CREDIT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hotel_credit`  COMMENT '施設別請求支払データ（カード決済）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hotel_credit_9xg`  COMMENT '施設別請求支払データ（カード決済）_テスト用;施設別請求支払データ（カード決済）本番テスト用';
--   *** ------------------------------------
--  *** LLPAY_HOTEL_FEE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hotel_fee`  COMMENT '施設別請求支払データ（システム利用料）;';
--   *** ------------------------------------
--  *** LLPAY_HOTEL_FEE_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hotel_fee_9xg`  COMMENT '	施設別請求支払データ（システム利用料）_テスト用;	施設別請求支払データ（システム利用料）本番テスト用';
--   *** ------------------------------------
--  *** LLPAY_HOTEL_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hotel_grants`  COMMENT '施設別請求支払データ（補助金）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hotel_grants_9xg`  COMMENT '	施設別請求支払データ（補助金）_テスト用;';
--   *** ------------------------------------
--  *** LLPAY_HOTEL_RSV
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hotel_rsv`  COMMENT '施設別請求支払データ（リザーブ）;';
--   *** ------------------------------------
--  *** LLPAY_HOTEL_RSV_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hotel_rsv_9xg`  COMMENT '施設別請求支払データ（リザーブ）_テスト用;施設別請求支払データ（リザーブ）本番テスト用';
--   *** ------------------------------------
--  *** LLPAY_HOTEL_YAHOO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hotel_yahoo`  COMMENT '施設別請求支払データ（ヤフー）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hotel_yahoo_9xg`  COMMENT '施設別請求支払データ（ヤフー）_テスト用;施設別請求支払データ（ヤフー）本番テスト用';
--   *** ------------------------------------
--  *** LLPAY_HR_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hr_grants`  COMMENT '宿泊別請求支払データ（補助金）;補助金適用先への精算用';
--   *** ------------------------------------
--  *** LLPAY_HR_GRANTS_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_hr_grants_9xg`  COMMENT '宿泊別請求支払データ（補助金）_テスト;';
--   *** ------------------------------------
--  *** LLPAY_PR_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_pr_grants`  COMMENT '宿泊別(補助金);';
--   *** ------------------------------------
--  *** LLPAY_PTN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_ptn`  COMMENT '提携先別;';
--   *** ------------------------------------
--  *** LLPAY_PTN_BOOK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_ptn_book`  COMMENT '提携先別台帳;';
--   *** ------------------------------------
--  *** LLPAY_PTN_CSTMR
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_ptn_cstmr`  COMMENT '精算先（提携先）;';
--   *** ------------------------------------
--  *** LLPAY_PTN_CSTMRSITE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_ptn_cstmrsite`  COMMENT '精算先関連サイト（提携先）;';
--   *** ------------------------------------
--  *** LLPAY_PTN_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_ptn_grants`  COMMENT '提携先別(補助金);';
--   *** ------------------------------------
--  *** LLPAY_PTN_SALES
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_ptn_sales`  COMMENT '提携先別（販売手数料）;';
--   *** ------------------------------------
--  *** LLPAY_PTN_SITE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_ptn_site`  COMMENT '提携サイト;';
--   *** ------------------------------------
--  *** LLPAY_PTN_STOCK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_ptn_stock`  COMMENT '提携先別（在庫手数料）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_ptn_type_grants`  COMMENT '提携先補助金種類別(補助金);';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_ptn_type_sales`  COMMENT '提携先在庫タイプ別（販売手数料）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_ptn_type_stock`  COMMENT '提携先在庫タイプ別（在庫手数料）;';
--   *** ------------------------------------
--  *** LLPAY_RSV
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_rsv`  COMMENT '宿泊別請求支払データ（リザーブ）;';
--   *** ------------------------------------
--  *** LLPAY_RSV_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_rsv_9xg`  COMMENT '宿泊別請求支払データ（リザーブ）_テスト用;宿泊別請求支払データ（リザーブ）本番テスト用';
--   *** ------------------------------------
--  *** LLPAY_SALES
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_sales`  COMMENT '宿泊別（販売手数料）;';
--   *** ------------------------------------
--  *** LLPAY_STOCK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_stock`  COMMENT '宿泊別（在庫手数料）;';
--   *** ------------------------------------
--  *** LLPAY_YAHOO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_yahoo`  COMMENT '宿泊別請求支払データ（ヤフー）;';
--   *** ------------------------------------
--  *** LLPAY_YAHOO_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `billpay_yahoo_9xg`  COMMENT '宿泊別請求支払データ（ヤフー）_テスト用;宿泊別請求支払データ（ヤフー）本番テスト用';
--   *** ------------------------------------
--  *** OADCAST_MESSAGE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `broadcast_message`  COMMENT '管理画面お知らせ;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `broadcast_messages_hotel`  COMMENT '管理画面お知らせ施設;';
--   *** ------------------------------------
--  *** _EKI_ROUTE_WK
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `br_point_book`  COMMENT 'BRポイント台帳;';
--   *** ------------------------------------
--  *** _POINT_BOOK_V3
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `br_point_book_v4`  COMMENT 'ＢＲポイント台帳（バージョン４）;確定ポイント保存テーブル';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `br_point_book_v4_draft`  COMMENT 'ＢＲポイント仮台帳（バージョン４）;仮ポイント保存テーブル';
--   *** ------------------------------------
--  *** _POINT_BOOK_V4_LOG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `br_point_book_v4_log`  COMMENT 'ＢＲポイント台帳（バージョン４）履歴;確定ポイント保存テーブル履歴';
--   *** ------------------------------------
--  *** _POINT_BOOK_V4_WK
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `br_point_gift_ticket`  COMMENT 'ＢＲポイントギフト交換宿泊割引券;';
--   *** ------------------------------------
--  *** _POINT_PLUS_HOTEL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `br_point_plus_hotel`  COMMENT 'BRポイント加算対象施設;';
--   *** ------------------------------------
--  *** _POINT_PLUS_INFO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `br_point_plus_info`  COMMENT 'BRポイント加算情報;施設様設定の付与ポイント率に対しBR側で加算するポイント率の履歴情報';
--   *** ------------------------------------
--  *** _POINT_PLUS_PLAN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `br_point_plus_plan`  COMMENT 'BRポイント加算対象プラン;';
--   *** ------------------------------------
--  *** _POINT_SERVICE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `br_point_service`  COMMENT 'BRポイントサービス一覧;';
--   *** ------------------------------------
--  *** _POINT_SHORT_TERM
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `br_point_short_term`  COMMENT '短期ポイント設定;短期ポイントのService_cdは「201203」です。';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `br_point_short_term_cond`  COMMENT '短期ポイント対象区分;';
--   *** ------------------------------------
--  *** _POINT_SPECIAL_MEMBER
--   *** ------------------------------------

  -- 
  CREATE TABLE `br_point_special_member` 
   (	`member_cd` VARCHAR(20) BINARY
   ) 
  ;
--   *** ------------------------------------
--  *** _POINT_STAY_COUNT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `br_point_stay_count`  COMMENT 'BRポイント宿泊カウント;';
--   *** ------------------------------------
--  *** _SS_IMPORT
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `card_payment_credit`  COMMENT 'クレジットカード決済データ（宿泊予約：一般）;';
--   *** ------------------------------------
--  *** RD_PAYMENT_GBY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `card_payment_gby`  COMMENT 'クレジットカード決済データ（共同販売：ベストク）;';
--   *** ------------------------------------
--  *** RD_PAYMENT_POWER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `card_payment_power`  COMMENT 'クレジットカード決済データ（宿泊予約：ハイランク）;';
--   *** ------------------------------------
--  *** ARGE
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `charge_condition`  COMMENT '料金登録状況;';
--   *** ------------------------------------
--  *** ARGE_EARLY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `charge_early`  COMMENT '早割料金情報;';
--   *** ------------------------------------
--  *** ARGE_INITIAL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `charge_initial`  COMMENT '料金基本情報;';
--   *** ------------------------------------
--  *** ARGE_REMIND
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `charge_remind`  COMMENT '料金入力補助;';
--   *** ------------------------------------
--  *** ARGE_TODAY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `charge_today`  COMMENT '当日料金情報;';
--   *** ------------------------------------
--  *** ECKSHEET_BOOK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_book`  COMMENT '送客データ（台帳）;';
--   *** ------------------------------------
--  *** ECKSHEET_CREDIT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_credit`  COMMENT '宿泊別送客データ（カード決済）;';
--   *** ------------------------------------
--  *** ECKSHEET_CUSTOMER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_customer`  COMMENT '請求支払先（送客）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_customer_9xg`  COMMENT '精算先（送客）_テスト用;精算先（送客）本番テスト用';
--   *** ------------------------------------
--  *** ECKSHEET_FEE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_fee`  COMMENT '宿泊別送客データ（システム利用料）;';
--   *** ------------------------------------
--  *** ECKSHEET_FIX
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_fix`  COMMENT '送客リスト確定テーブル;';
--   *** ------------------------------------
--  *** ECKSHEET_FIX_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_fix_9xg`  COMMENT '送客リスト検収テーブル_テスト用;送客リスト検収テーブル本番テスト用';
--   *** ------------------------------------
--  *** ECKSHEET_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_grants`  COMMENT '宿泊別送客データ（補助金）;';
--   *** ------------------------------------
--  *** ECKSHEET_GRANTS_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_grants_9xg`  COMMENT '宿泊別送客データ（補助金）_テスト;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_hotel_credit`  COMMENT '施設別送客データ（カード決済）;';
--   *** ------------------------------------
--  *** ECKSHEET_HOTEL_FEE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_hotel_fee`  COMMENT '施設送客データ（システム利用料）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_hotel_fee_base`  COMMENT '施設別送客データ（システム利用料）基準;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_hotel_grants`  COMMENT '施設別送客データ（補助金）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_hotel_grants_9xg`  COMMENT '施設別送客データ（補助金）_テスト;';
--   *** ------------------------------------
--  *** ECKSHEET_HOTEL_RSV
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_hotel_rsv`  COMMENT '施設別送客データ（リザーブ）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_hotel_yahoo`  COMMENT '送客施設データ（ヤフー）;';
--   *** ------------------------------------
--  *** ECKSHEET_ORDER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_order`  COMMENT '送客リスト送付優先順序;';
--   *** ------------------------------------
--  *** ECKSHEET_RSV
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_rsv`  COMMENT '宿泊別送客データ（リザーブ）;';
--   *** ------------------------------------
--  *** ECKSHEET_YAHOO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `checksheet_yahoo`  COMMENT '送客データ（ヤフー）;';
--   *** ------------------------------------
--  *** NFIRM_HOTEL_PERSON
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `confirm_hotel_person`  COMMENT '担当者情報更新確認;施設担当者・精算担当者の情報を定期的に確認する。';
--   *** ------------------------------------
--  *** NTACT_SENDBOX
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `contact_sendbox`  COMMENT '施設から会員へのメール送信;';
--   *** ------------------------------------
--  *** STOMER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `customer`  COMMENT '請求支払先;';
--   *** ------------------------------------
--  *** STOMER_HIKARI
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `customer_hotel`  COMMENT '請求先・支払先関連施設;';
--   *** ------------------------------------
--  *** NY_LIST
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `deny_list`  COMMENT '提携先・施設拒否関連;提携サイトに表示したくない施設を設定する';
--   *** ------------------------------------
--  *** NY_LIST_RETURN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `deny_list_return`  COMMENT '提携先・施設拒否復帰一覧;';
--   *** ------------------------------------
--  *** SPOSE_VOUCHER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `dispose_voucher`  COMMENT '赤伝票;';
--   *** ------------------------------------
--  *** QUETE_6315
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `enquete_6315`  COMMENT 'ベストリザーブアンケート（タスク6315）;';
--   *** ------------------------------------
--  *** ARK_ACCESS_TOKEN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `epark_access_token`  COMMENT 'EPARK連携Access_Token;EPARK連携時のAccess_Tokenを保持する';
--   *** ------------------------------------
--  *** ARK_REFRESH_TOKEN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `epark_refresh_token`  COMMENT 'EPARK連携Refresh_Token;EPARK連携時のRefresh_Tokenを保持する';
--   *** ------------------------------------
--  *** ARK_STATE_TOKEN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `epark_state_token`  COMMENT 'EPARK連携State_Token;EPARK連携時のstate_tokenを保持する';
--   *** ------------------------------------
--  *** TEND_SETTING
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `extend_setting`  COMMENT '自動登録管理テーブル;';
--   *** ------------------------------------
--  *** TEND_SETTING_PLAN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `extend_setting_plan`  COMMENT 'プランの自動延長設定;自動延長のON/OFF設定（プラン単位）';
--   *** ------------------------------------
--  *** TEND_SETTING_ROOM
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `extend_setting_room`  COMMENT '部屋の自動延長設定;自動延長のON/OFF設定';
--   *** ------------------------------------
--  *** TEND_SWITCH
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `extend_switch`  COMMENT '自動登録状態管理テーブル;';
--   *** ------------------------------------
--  *** TEND_SWITCH_PLAN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `extend_switch_plan`  COMMENT 'プラン自動延長状態;';
--   *** ------------------------------------
--  *** TEND_SWITCH_PLAN2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `extend_switch_plan2`  COMMENT 'プラン自動延長状態;';
--   *** ------------------------------------
--  *** TEND_TASK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `extend_task`  COMMENT '手動延長処理管理テーブル;手動延長処理のタスクを管理する';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `factoring_zengin_request`  COMMENT '引落顧客リクエスト状況;';
--   *** ------------------------------------
--  *** X_PR
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `fax_pr`  COMMENT '予約通知FAX掲載広告文章;予約通知FAXに記載する広告文章を登録します';
--   *** ------------------------------------
--  *** _BASE_TIME
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `fd_base_time`  COMMENT '外部連携基準時間;';
--   *** ------------------------------------
--  *** ATURE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `feature`  COMMENT '特集;特集ページ毎の情報を保持する';
--   *** ------------------------------------
--  *** ATURE_DETAIL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `feature_detail`  COMMENT '特集詳細;特集ページに表示する施設、プラン情報を保持する。';
--   *** ------------------------------------
--  *** _AFFILIATE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `fm_affiliate`  COMMENT 'アフィリエイトマスタ;';
--   *** ------------------------------------
--  DDL for Table GIFT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `gift`  COMMENT 'ギフトデータ;';
--   *** ------------------------------------
--  *** FT_ORDER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `gift_order`  COMMENT 'Mtg\f[^igift_track_goods ??sj;';
--   *** ------------------------------------
--  *** FT_SUPPLIER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `gift_supplier`  COMMENT 'ギフト提携先;';
--   *** ------------------------------------
--  *** UDA_AR_TEST
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `gouda_ar_test`  COMMENT 'テスト;';
--   *** ------------------------------------
--  *** OUP_BUYING
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `group_buying`  COMMENT '共同購入商品;';
--   *** ------------------------------------
--  *** OUP_BUYING_5273
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `group_buying_5273`  COMMENT '共同購入キャンペーン（タスク5273）;';
--   *** ------------------------------------
--  *** OUP_BUYING_AUTHORI
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `group_buying_authori`  COMMENT '共同購入商品カード決済オーソリ;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `group_buying_card`  COMMENT '共同購入商品カード;';
--   *** ------------------------------------
--  *** OUP_BUYING_COUPON
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `group_buying_coupon`  COMMENT '共同購入商品注文クーポン;';
--   *** ------------------------------------
--  *** OUP_BUYING_DELIVERY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `group_buying_delivery`  COMMENT '共同購入商品発送先;発送先情報';
--   *** ------------------------------------
--  *** OUP_BUYING_DETAIL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `group_buying_detail`  COMMENT '共同購入商品詳細;';
--   *** ------------------------------------
--  *** OUP_BUYING_GENRE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `group_buying_genre`  COMMENT '共同購入ジャンル;';
--   *** ------------------------------------
--  *** OUP_BUYING_HOTEL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `group_buying_hotel`  COMMENT '共同購入商品施設マッチングデータ;';
--   *** ------------------------------------
--  *** OUP_BUYING_ORDER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `group_buying_order`  COMMENT '共同購入商品注文;';
--   *** ------------------------------------
--  *** OUP_BUYING_SUPPLIER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `group_buying_supplier`  COMMENT '共同購入提供先;';
--   *** ------------------------------------
--  *** KARI_ACCOUNT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hikari_account`  COMMENT '光通信ログイン情報;';
--   *** ------------------------------------
--  *** TEL
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_accept_history`  COMMENT '予約受付状態履歴テーブル;予約受付状態の受付/停止の変更履歴を管理する。';
--   *** ------------------------------------
--  *** TEL_ACCOUNT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_account`  COMMENT '施設認証;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_advert_2009000400`  COMMENT '広告掲載施設;「迷わずこお！」の広告用テーブル（アフリエイトコード ：2009000400 ）';
--   *** ------------------------------------
--  *** TEL_AMENITY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_amenity`  COMMENT '施設アメニティ;施設アイテムマスタより';
--   *** ------------------------------------
--  *** TEL_AREA
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_area`  COMMENT '施設エリア;';
--   *** ------------------------------------
--  *** TEL_BATH_TAX
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_bath_tax`  COMMENT '施設入湯税;';
--   *** ------------------------------------
--  *** TEL_CAMP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_camp`  COMMENT '施設キャンペーン;';
--   *** ------------------------------------
--  *** TEL_CAMP_GOTO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_camp_goto`  COMMENT '施設キャンペーンGoTo;施設キャンペーンGoTo専用';
--   *** ------------------------------------
--  *** TEL_CAMP_PLAN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_camp_plan`  COMMENT '施設キャンペーン部屋プラン;';
--   *** ------------------------------------
--  *** TEL_CAMP_PLAN2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_camp_plan2`  COMMENT '施設キャンペーンプラン HTL121;';
--   *** ------------------------------------
--  *** TEL_CAMP_PLAN2_GOTO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_camp_plan2_goto`  COMMENT '施設キャンペーンプランGoTo;施設キャンペーンプランGoTo用';
--   *** ------------------------------------
--  *** TEL_CAMP_PLAN_GOTO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_camp_plan_goto`  COMMENT '施設キャンペーン部屋プランGoTo;施設キャンペーン部屋プランGoTo用';
--   *** ------------------------------------
--  *** TEL_CANCEL_POLICY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_cancel_policy`  COMMENT '施設キャンセルポリシー;';
--   *** ------------------------------------
--  *** TEL_CANCEL_RATE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_cancel_rate`  COMMENT '施設キャンセル料率;';
--   *** ------------------------------------
--  *** TEL_CARD
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_card`  COMMENT '施設利用可能カード;';
--   *** ------------------------------------
--  *** TEL_CONTROL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_control`  COMMENT '施設管理;';
--   *** ------------------------------------
--  *** TEL_CONTROL_NOTE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_control_note`  COMMENT '施設宿泊時備考設定;';
--   *** ------------------------------------
--  *** TEL_ELEMENT_REMOVED
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_element_removed`  COMMENT '施設要素削除情報テーブル;';
--   *** ------------------------------------
--  *** TEL_FACILITY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_facility`  COMMENT '施設設備;施設アイテムマスタより';
--   *** ------------------------------------
--  *** TEL_FACILITY_ROOM
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_facility_room`  COMMENT '施設部屋設備;施設アイテムマスタより';
--   *** ------------------------------------
--  *** TEL_GOTO_EXCEL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_goto_excel`  COMMENT 'GotoキャンペーンEXCELupload状況;Gotoキャンペーンの地域共通クーポンの紐付けEXCELのupload状況を管理する';
--   *** ------------------------------------
--  *** TEL_GOTO_REGIST
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_goto_regist`  COMMENT 'Gotoキャンペーン事業者登録回答状況;Gotoキャンペーン事業者登録回答状況を保管する';
--   *** ------------------------------------
--  *** TEL_INFO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_info`  COMMENT '施設情報;';
--   *** ------------------------------------
--  *** TEL_INFORM
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_inform`  COMMENT '施設連絡事項;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_insurance_weather`  COMMENT '施設お天気保険サービス管理;';
--   *** ------------------------------------
--  *** TEL_JR_ENTRY_STATUS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_jr_entry_status`  COMMENT '施設JRセット参画状態;施設JRセットプラン参画状態';
--   *** ------------------------------------
--  *** TEL_LANDMARK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_landmark`  COMMENT '施設ランドマーク;';
--   *** ------------------------------------
--  *** TEL_LANDMARK_SURVEY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_landmark_survey`  COMMENT 'ランドマーク付近施設;';
--   *** ------------------------------------
--  *** TEL_LINK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_link`  COMMENT '施設リンク;';
--   *** ------------------------------------
--  *** TEL_MEDIA
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_media`  COMMENT '施設メディア;';
--   *** ------------------------------------
--  *** TEL_MODIFY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_modify`  COMMENT '施設情報ページ更新対象テーブル;';
--   *** ------------------------------------
--  *** TEL_MSC
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_msc`  COMMENT '施設マルチサイトコントローラ利用状況;';
--   *** ------------------------------------
--  *** TEL_MSC_LOGIN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_msc_login`  COMMENT '施設マルチサイトコントローラログイン状況（将来実装）;リンカーン、ねっぱんでログインされたときnotifyを自動生成してもよいのかあかんのか';
--   *** ------------------------------------
--  *** TEL_NEARBY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_nearby`  COMMENT '施設周辺情報;施設アイテムマスタより';
--   *** ------------------------------------
--  *** TEL_NOTIFY
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_pay_per_call`  COMMENT 'Pay Per Call用テーブル;';
--   *** ------------------------------------
--  *** TEL_PERSON
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_person`  COMMENT '施設管理サイト担当者;';
--   *** ------------------------------------
--  *** TEL_POWERDOWN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_powerdown`  COMMENT '施設パワーダウン;パーホテルの割引情報';
--   *** ------------------------------------
--  *** TEL_POWERDOWN_S
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_powerdown_s`  COMMENT '施設パワーダウン（特別）;パワーホテルの割引情報';
--   *** ------------------------------------
--  *** TEL_PREMIUM
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_premium`  COMMENT 'プレミアム施設;';
--   *** ------------------------------------
--  *** TEL_PRIORITY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_priority`  COMMENT '重点表示ホテル;重点表示ホテルを保持します。';
--   *** ------------------------------------
--  *** TEL_RATE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_rate`  COMMENT 'システム利用料率マスタ;';
--   *** ------------------------------------
--  *** TEL_RECEIPT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_receipt`  COMMENT '施設レシート;';
--   *** ------------------------------------
--  *** TEL_RECOMMEND
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_recommend`  COMMENT 'ホテルおすすめ情報;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_recommend_result`  COMMENT 'ホテルおすすめ情報結果;';
--   *** ------------------------------------
--  *** TEL_RELATION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_relation`  COMMENT '施設関連付け;ブロック、パワー、バルクの関連付けるテーブル';
--   *** ------------------------------------
--  *** TEL_REVIEW
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_review`  COMMENT '施設クチコミ評価;Voice_review の平均値 ＋ 補正値 で評価点を求める（最大５）';
--   *** ------------------------------------
--  *** TEL_SEARCH_WORDS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_search_words`  COMMENT '施設検索用データ;';
--   *** ------------------------------------
--  *** TEL_SERVICE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_service`  COMMENT '施設サービス;施設アイテムマスタより';
--   *** ------------------------------------
--  *** TEL_SPOT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_spot`  COMMENT 'スポット施設;';
--   *** ------------------------------------
--  *** TEL_STAFF_NOTE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_staff_note`  COMMENT '施設スタッフノート;営業用の備考';
--   *** ------------------------------------
--  *** TEL_STATION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_station`  COMMENT '施設最寄駅;';
--   *** ------------------------------------
--  *** TEL_STATIONS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_stations`  COMMENT '施設の最寄り駅;';
--   *** ------------------------------------
--  *** TEL_STATIONS_SURVEY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_stations_survey`  COMMENT '駅付近施設;station_cdからstation_idに変更したバージョン';
--   *** ------------------------------------
--  *** TEL_STATION_SURVEY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_station_survey`  COMMENT '駅付近施設;';
--   *** ------------------------------------
--  *** TEL_STATION_WK
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_status`  COMMENT '施設状況;';
--   *** ------------------------------------
--  *** TEL_STATUS_JR
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_status_jr`  COMMENT '施設JRセット参画状態;施設JRセットプラン参画状態';
--   *** ------------------------------------
--  *** TEL_SUPERVISOR
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_supervisor`  COMMENT '施設統括;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_supervisor_account`  COMMENT '施設統括認証;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_supervisor_hotel`  COMMENT '施設統括施設;';
--   *** ------------------------------------
--  *** TEL_SURVEY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_survey`  COMMENT '施設測地;東京測地系と世界測地系の緯度経度を保持（計算式に使用する場合は、度表記を使用）';
--   *** ------------------------------------
--  *** TEL_SYSTEM_VERSION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_system_version`  COMMENT '管理システム利用バージョン;';
--   *** ------------------------------------
--  *** TEL_TYK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_tyk`  COMMENT '東横イン施設関連付けテーブル;';
--   *** ------------------------------------
--  *** TEL_TYPE_20170101
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_type_20170101`  COMMENT '施設区分_20170101_料率付与率改定用;20170101からのシステム料率並びにポイント料率改定のための施設区分判定用テーブル';
--   *** ------------------------------------
--  *** TEL_VISUAL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_visual`  COMMENT '施設ヴィジュアルパッケージ;';
--   *** ------------------------------------
--  *** TEL_YAHOO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_yahoo`  COMMENT 'Yahoo施設関連付け;複数施設の取り扱いテーブル';
--   *** ------------------------------------
--  *** TEL_YDK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_ydk`  COMMENT '宿研施設関連付けテーブル;';
--   *** ------------------------------------
--  *** TEL_YDP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_ydp`  COMMENT '日本旅行_施設関連付け;';
--   *** ------------------------------------
--  *** TEL_YDP2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_ydp2`  COMMENT '日本旅行施設移行対応;';
--   *** ------------------------------------
--  *** TEL_YDP2_YAHOO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_ydp2_yahoo`  COMMENT '日本旅行施設移行対応（ヤフーデータ提供）;';
--   *** ------------------------------------
--  *** TEL_YDP_BR
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_ydp_br`  COMMENT '宿ぷらざ施設関連テーブル;';
--   *** ------------------------------------
--  *** TEL_YDP_FACTORING
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_ydp_factoring`  COMMENT '日本旅行引落口座一覧;';
--   *** ------------------------------------
--  *** TEL_YDP_MATCH
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `hotel_ydp_match`  COMMENT '宿ぷらざリダイレクト設定（施設）;';
--   *** ------------------------------------
--  *** URNAL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `journal`  COMMENT 'ジャーナル;データ更新情報';
--   *** ------------------------------------
--  *** YWORDS_HOTEL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `keywords_hotel`  COMMENT '施設キーワード;';
--   *** ------------------------------------
--  *** YWORDS_PLAN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `keywords_plan`  COMMENT 'プランキーワード;';
--   *** ------------------------------------
--  *** NDMARKS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `landmarks`  COMMENT 'ランドマーク情報;新仕様。旧(mast_landmark)は将来廃棄予定';
--   *** ------------------------------------
--  *** NDMARK_BASIC_INFO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `landmark_basic_info`  COMMENT 'ランドマーク基本情報;';
--   *** ------------------------------------
--  *** NDMARK_CAMPAIGN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `landmark_campaign`  COMMENT 'ランドマークキャンペーン情報;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `landmark_category_match`  COMMENT 'ランドマークカテゴリマッチ;';
--   *** ------------------------------------
--  *** NDMARK_PREF_MATCH
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `landmark_pref_match`  COMMENT 'ランドマーク都道府県マッチ;';
--   *** ------------------------------------
--  *** G_ALERT_STOCK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_alert_stock`  COMMENT '在庫アラートログ;';
--   *** ------------------------------------
--  *** G_AUTHORI
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_authori`  COMMENT 'オーソリログ;オーソリ時に作成されます。';
--   *** ------------------------------------
--  *** G_BOUNCED_MAIL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_bounced_mail`  COMMENT '送信失敗メールリスト;';
--   *** ------------------------------------
--  *** G_CANCEL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_cancel`  COMMENT 'キャンセルログ;';
--   *** ------------------------------------
--  *** G_CREDIT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_credit`  COMMENT 'クレジットカード決済オーソリログ;';
--   *** ------------------------------------
--  *** G_CUSTOMER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_customer`  COMMENT '精算担当者情報履歴;';
--   *** ------------------------------------
--  *** G_EXTEND
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_extend`  COMMENT '自動登録ログ;';
--   *** ------------------------------------
--  *** G_EXTEND_DETAIL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_extend_detail`  COMMENT '販売自動延長詳細ログ;';
--   *** ------------------------------------
--  *** G_EXTEND_DETAIL2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_extend_detail2`  COMMENT '販売自動延長詳細ログ2;';
--   *** ------------------------------------
--  *** G_GROUP_BUYING
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_group_buying`  COMMENT '共同購入オーソリログ;';
--   *** ------------------------------------
--  *** G_HOTEL_PERSON
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_hotel_person`  COMMENT '施設担当者情報履歴;';
--   *** ------------------------------------
--  *** G_NOTIFY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_notify`  COMMENT '通知ログ;';
--   *** ------------------------------------
--  *** G_PLAN_STATUS_POOL2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_plan_status_pool2`  COMMENT 'プラン審査履歴;';
--   *** ------------------------------------
--  *** G_POWER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_power`  COMMENT 'パワーオーソリログ;オーソリ時に作成されます。';
--   *** ------------------------------------
--  *** G_RIZAPULI_NOTIFY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_rizapuli_notify`  COMMENT '通知ログ（リザプリ）;リザプリ用通知ログ';
--   *** ------------------------------------
--  *** G_SECURITY_01
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_security_01`  COMMENT 'セキュリティログ１月;';
--   *** ------------------------------------
--  *** G_SECURITY_02
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_security_02`  COMMENT 'セキュリティログ２月;';
--   *** ------------------------------------
--  *** G_SECURITY_03
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_security_03`  COMMENT 'セキュリティログ３月;';
--   *** ------------------------------------
--  *** G_SECURITY_04
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_security_04`  COMMENT 'セキュリティログ４月;';
--   *** ------------------------------------
--  *** G_SECURITY_05
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_security_05`  COMMENT 'セキュリティログ５月;';
--   *** ------------------------------------
--  *** G_SECURITY_06
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_security_06`  COMMENT 'セキュリティログ６月;';
--   *** ------------------------------------
--  *** G_SECURITY_07
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_security_07`  COMMENT 'セキュリティログ７月;';
--   *** ------------------------------------
--  *** G_SECURITY_08
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_security_08`  COMMENT 'セキュリティログ８月;';
--   *** ------------------------------------
--  *** G_SECURITY_09
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_security_09`  COMMENT 'セキュリティログ９月;';
--   *** ------------------------------------
--  *** G_SECURITY_10
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_security_10`  COMMENT 'セキュリティログ１０月;';
--   *** ------------------------------------
--  *** G_SECURITY_11
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_security_11`  COMMENT 'セキュリティログ１１月;';
--   *** ------------------------------------
--  *** G_SECURITY_12
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `log_security_12`  COMMENT 'セキュリティログ１２月;';
--   *** ------------------------------------
--  *** ILMAG_V2_SET
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mailmag_v2_set`  COMMENT 'メールマガジン（バージョン2）送信設定;メールマガジン（バージョン2）の送信状態保存テーブル';
--   *** ------------------------------------
--  *** IL_MAGAZINE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mail_magazine`  COMMENT 'メールマガジン;メールマガジンのデータです。';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mail_magazine_back_number`  COMMENT 'メールマガジンバックナンバー;バックナンバー';
--   *** ------------------------------------
--  *** IL_MAGAZINE_SIMPLE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mail_magazine_simple`  COMMENT '汎用メールマガジン;差し込みデータなし＆BCCでの配信';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mail_magazine_simple_bcc`  COMMENT '汎用メールマガジン宛先;汎用メールマガジン配信先';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mail_magazine_simple_cond`  COMMENT '汎用メールマガジン送信対象;汎用メールマガジン送信対象の条件';
--   *** ------------------------------------
--  *** ST_AMEDAS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_amedas`  COMMENT 'アメダス設置位置;JBR提供のアメダス設置位置一覧より展開';
--   *** ------------------------------------
--  *** ST_AREA
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_area`  COMMENT '地域;';
--   *** ------------------------------------
--  *** ST_AREA_LANDMARK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_area_landmark`  COMMENT '地域別ランドマーク;';
--   *** ------------------------------------
--  *** ST_AREA_MATCH
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_area_match`  COMMENT '地域市区マッチ;';
--   *** ------------------------------------
--  *** ST_AREA_NEARBY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_area_nearby`  COMMENT '近隣エリアマッチ;';
--   *** ------------------------------------
--  *** ST_AREA_STATION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_area_station`  COMMENT '地域別駅;';
--   *** ------------------------------------
--  *** ST_AREA_SURVEY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_area_survey`  COMMENT '地域ごとの緯度経度;';
--   *** ------------------------------------
--  *** ST_BANK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_bank`  COMMENT '銀行マスタ;';
--   *** ------------------------------------
--  *** ST_BANK_BRANCH
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_bank_branch`  COMMENT '銀行支店マスタ;';
--   *** ------------------------------------
--  *** ST_CALENDAR
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_calendar`  COMMENT 'カレンダーマスタ;';
--   *** ------------------------------------
--  *** ST_CARD
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_card`  COMMENT 'カードマスタ;';
--   *** ------------------------------------
--  *** ST_CITY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_city`  COMMENT '市マスタ;';
--   *** ------------------------------------
--  *** ST_HOLIDAY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_holiday`  COMMENT '祝祭日マスタ;';
--   *** ------------------------------------
--  *** ST_HOTEL_ELEMENT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_hotel_element`  COMMENT '施設要素マスタ;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_hotel_element_value`  COMMENT '施設値選択マスタ;';
--   *** ------------------------------------
--  *** ST_KEYWORDS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_keywords`  COMMENT 'キーワード辞書マスタ;プランに含まれるキーワード一覧';
--   *** ------------------------------------
--  *** ST_KEYWORD_GROUP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_keyword_group`  COMMENT 'キーワードグループマスタ;';
--   *** ------------------------------------
--  *** ST_KEYWORD_MATCH
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_keyword_match`  COMMENT 'キーワードグループマッチ;';
--   *** ------------------------------------
--  *** ST_LANDMARK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_landmark`  COMMENT 'ランドマークマスタ;';
--   *** ------------------------------------
--  *** ST_LANDMARK_BASIC
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_landmark_basic`  COMMENT 'ランドマーク基本情報項目マスタ;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_landmark_category_1st`  COMMENT 'ランドマーク大カテゴリマスタ;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_landmark_category_2nd`  COMMENT 'ランドマーク中カテゴリマスタ;';
--   *** ------------------------------------
--  *** ST_MONEY_SCHEDULE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_money_schedule`  COMMENT '経理関係スケジュールマスタ;';
--   *** ------------------------------------
--  *** ST_PLAN_ELEMENT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_plan_element`  COMMENT 'プラン要素マスタ;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_plan_element_value`  COMMENT 'プラン値選択マスタ;';
--   *** ------------------------------------
--  *** ST_PREF
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_pref`  COMMENT '都道府県マスタ;';
--   *** ------------------------------------
--  *** ST_RECOMMEND
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_region`  COMMENT '地方マスタ;';
--   *** ------------------------------------
--  *** ST_REVIEW
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_review`  COMMENT 'クチコミ項目;';
--   *** ------------------------------------
--  *** ST_ROUTE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_route`  COMMENT '路線マスタ;';
--   *** ------------------------------------
--  *** ST_ROUTES
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_routes`  COMMENT '路線マスタ;ver2';
--   *** ------------------------------------
--  *** ST_STATION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_station`  COMMENT '駅マスタ;';
--   *** ------------------------------------
--  *** ST_STATIONS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_stations`  COMMENT '駅マスタ;ver2';
--   *** ------------------------------------
--  *** ST_STATION_COMPANY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_station_company`  COMMENT '駅事業者マスタ;';
--   *** ------------------------------------
--  *** ST_STATION_JUNCTION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_station_junction`  COMMENT '駅ジャンクション;';
--   *** ------------------------------------
--  *** ST_TAX
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_tax`  COMMENT '消費税率マスタ;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_vr_hotel_category`  COMMENT 'ベンチャーリパブリック連携施設区分マスタ;ベンチャーリパブリックとのデータ連携用の施設区分マスタ';
--   *** ------------------------------------
--  *** ST_VR_ITEM
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_vr_item`  COMMENT 'ベンチャーリパブリック連携用途マスタ;ベンチャーリパブリックとのデータ連携用の用途マスタ';
--   *** ------------------------------------
--  *** ST_VR_ROOM_TYPE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_vr_room_type`  COMMENT 'ベンチャーリパブリック連携部屋タイプマスタ;ベンチャーリパブリックとのデータ連携用の部屋タイプマスタ';
--   *** ------------------------------------
--  *** ST_WARD
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_ward`  COMMENT '区マスタ;';
--   *** ------------------------------------
--  *** ST_WARDZONE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_wardzone`  COMMENT '区割マスタ;';
--   *** ------------------------------------
--  *** ST_WARDZONE_DETAIL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mast_wardzone_detail`  COMMENT '区割の所属;地区と区の関連付け';
--   *** ------------------------------------
--  *** DIA
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `media`  COMMENT 'メディア;';
--   *** ------------------------------------
--  *** DIA_ORG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `media_org`  COMMENT 'メディアオリジナル名称情報;施設画像ファイルのファイル名称を管理(画像アップロード後ファイル名をリネームするため)';
--   *** ------------------------------------
--  *** DIA_REMOVED
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `media_removed`  COMMENT '画像削除情報;施設、部屋、プランに関連する画像が削除されたときに登録される';
--   *** ------------------------------------
--  *** MBER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member`  COMMENT '会員情報;';
--   *** ------------------------------------
--  *** MBER_CARD
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_card`  COMMENT '会員カード情報;';
--   *** ------------------------------------
--  *** MBER_COUPON
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_coupon`  COMMENT '会員保持クーポン;会員が保持しているクーポンを格納する';
--   *** ------------------------------------
--  *** MBER_CREDITCARD
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_creditcard`  COMMENT '会員カード情報（提携先対応）;';
--   *** ------------------------------------
--  *** MBER_DETAIL
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_detail_sp`  COMMENT '会員情報詳細;';
--   *** ------------------------------------
--  *** MBER_EPARK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_epark`  COMMENT 'EPARK連携会員情報;EPARKの会員情報を保持する';
--   *** ------------------------------------
--  *** MBER_EPKP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_epkp`  COMMENT 'EPK予約者情報;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_forced_stop_mail`  COMMENT 'メール送信強制停止テーブル;会員へのメールマガジン等のメール送信を強制的に停止する';
--   *** ------------------------------------
--  *** MBER_FREE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_free`  COMMENT 'フリーユーザ情報;';
--   *** ------------------------------------
--  *** MBER_FREE_RELATION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_free_relation`  COMMENT '会員非会員関連付け;非会員から会員になった関連付けテーブル';
--   *** ------------------------------------
--  *** MBER_FREE_TRACE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_free_trace`  COMMENT '非会員予約でのトレース情報;';
--   *** ------------------------------------
--  *** MBER_HOTELS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_hotels`  COMMENT '会員利用ホテル;クリップホテル・表示ホテル';
--   *** ------------------------------------
--  *** MBER_HOTELS2
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_jwest`  COMMENT 'JRおでかけネット会員情報;';
--   *** ------------------------------------
--  *** MBER_LIVEDOOR
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_livedoor`  COMMENT 'ライブドア予約者情報;';
--   *** ------------------------------------
--  *** MBER_MAIL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_mail`  COMMENT '会員メールアドレス;';
--   *** ------------------------------------
--  *** MBER_MOBILE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_mobile`  COMMENT '契約者固有IDテーブル;';
--   *** ------------------------------------
--  *** MBER_MOBILE_MAIL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_mobile_mail`  COMMENT 'モバイルメールマガジン送信否;会員へのメール送信否（member_sending_mail）の携帯版';
--   *** ------------------------------------
--  *** MBER_POINT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_point`  COMMENT '会員BRポイント設定;';
--   *** ------------------------------------
--  *** MBER_SEARCH_MAIL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_search_mail`  COMMENT '会員メールアドレス検索用テーブル;';
--   *** ------------------------------------
--  *** MBER_SEARCH_MAIL_SP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_search_mail_sp`  COMMENT '会員メールアドレス検索用テーブルSP;';
--   *** ------------------------------------
--  *** MBER_SENDING_MAIL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_sending_mail`  COMMENT '会員へのメール送信否;送信しないメールアドレスを設定';
--   *** ------------------------------------
--  *** MBER_SP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_sp`  COMMENT '会員情報;';
--   *** ------------------------------------
--  *** MBER_SSO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_sso`  COMMENT '会員SSO;会員のSSOに関する情報を管理します。';
--   *** ------------------------------------
--  *** MBER_STAFF_NOTE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_staff_note`  COMMENT '会員スタッフノート;';
--   *** ------------------------------------
--  *** MBER_YAHOO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_yahoo`  COMMENT 'Yahoo予約者情報;';
--   *** ------------------------------------
--  *** MBER_YDP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_ydp`  COMMENT '日本旅行会員移行対応;';
--   *** ------------------------------------
--  *** MBER_ZAP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `member_zap`  COMMENT '旧会員情報;';
--   *** ------------------------------------
--  *** GRATION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `migration`  COMMENT 'マイグレーション;';
--   *** ------------------------------------
--  *** GRATION_BASE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `migration_base`  COMMENT 'マイグレーション基本情報;';
--   *** ------------------------------------
--  *** GRATION_CANCEL_RATE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `migration_cancel_rate`  COMMENT 'マイグレーションキャンセル料率;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `migration_cancel_rate_temp`  COMMENT '販売提携グループキャンセル料率（保存用）;';
--   *** ------------------------------------
--  *** GRATION_CHARGE_TEMP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `migration_charge_temp`  COMMENT '販売提携グループ料金（保存用）;';
--   *** ------------------------------------
--  *** GRATION_MATCH
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `migration_match`  COMMENT 'マイグレーションプラン統合;';
--   *** ------------------------------------
--  *** GRATION_MEDIA
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `migration_media`  COMMENT 'マイグレーションメディア;';
--   *** ------------------------------------
--  *** GRATION_PLAN_TEMP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `migration_plan_temp`  COMMENT '販売提携グループプラン（保存用）;';
--   *** ------------------------------------
--  *** GRATION_SPEC
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `migration_spec`  COMMENT 'マイグレーションスペック;';
--   *** ------------------------------------
--  *** S_GENRE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mms_genre`  COMMENT '汎用メールマガジンジャンル;汎用メールマガジンのジャンル';
--   *** ------------------------------------
--  *** S_LINK_ANALYZE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mms_link_analyze`  COMMENT '汎用メールマガジンリンク分析;汎用メールマガジン本文内のリンク分析結果（mms→mail_magazine_simple）';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mms_send_extract_condition`  COMMENT '汎用メールマガジン送信対象抽出条件;汎用メールマガジン特殊な送信対象抽出条件（mms→mail_magazine_simple）';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `mms_send_extract_reration`  COMMENT '汎用メルマガと特殊な抽出条件の関連付け;汎用メルマガと特殊な抽出条件の関連付け';
--   *** ------------------------------------
--  *** NEY_SCHEDULE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `money_schedule`  COMMENT '経理関係スケジュール;';
--   *** ------------------------------------
--  *** _HOTEL_LIST
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `my_hotel_list`  COMMENT 'MYホテル一覧;';
--   *** ------------------------------------
--  *** _HOTEL_RESERVED
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `my_hotel_reserved`  COMMENT '会員予約ホテルリスト;会員が過去に宿泊したホテルリスト（電話キャンセル：NOSHOW未対応';
--   *** ------------------------------------
--  *** _SEARCH_SETTING
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `my_search_setting`  COMMENT 'ＭＹ検索条件;';
--   *** ------------------------------------
--  *** _SETTING
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `my_setting`  COMMENT 'ＭＹＰＡＧＥ表示制御;検索ホームのデフォルト表示項目等をせっていする。';
--   *** ------------------------------------
--  *** TIFY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `notify`  COMMENT '通知;原稿作成判断用';
--   *** ------------------------------------
--  *** TIFY_DETAIL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `notify_detail`  COMMENT '通知詳細;通知対象となるデータ';
--   *** ------------------------------------
--  *** TIFY_PAGE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `notify_page`  COMMENT 'ファックス枚数;ファックスの送信枚数を保存します';
--   *** ------------------------------------
--  *** TIFY_RIZAPULI
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `notify_rizapuli`  COMMENT '通知（リザプリ）;リザプリ原稿作成判断用';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `notify_rizapuli_detail`  COMMENT '通知詳細（リザプリ）;リザプリの通知対象となるデータ情報管理';
--   *** ------------------------------------
--  *** TIFY_RIZAPULI_STAY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `notify_rizapuli_stay`  COMMENT '前回通知宿泊日（リザプリ）;前回通知時に「○」にて通知した一覧を保持';
--   *** ------------------------------------
--  *** TIFY_STAY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `notify_stay`  COMMENT '前回通知宿泊日;前回通知時に「○」にて通知した一覧を保持';
--   *** ------------------------------------
--  *** A_STAFF
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `nta_staff`  COMMENT '日本旅行スタッフ;';
--   *** ------------------------------------
--  *** A_STAFF_ACCOUNT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `nta_staff_account`  COMMENT '日本旅行スタッフアカウント;';
--   *** ------------------------------------
--  *** DER_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `order_grants`  COMMENT '予約申込補助金情報;予約申込単位での適用された補助金情報';
--   *** ------------------------------------
--  *** ICO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `orico`  COMMENT '決済テーブル;';
--   *** ------------------------------------
--  *** ICOPAYMENT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `oricopayment`  COMMENT 'オリコペイメント売上データ;';
--   *** ------------------------------------
--  *** ICO_RESERVE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `orico_reserve`  COMMENT '予約決済テーブル;';
--   *** ------------------------------------
--  *** ICO_RESERVE_HISTORY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `orico_reserve_history`  COMMENT '予約与信テーブル履歴;';
--   *** ------------------------------------
--  *** ICO_RETRY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `orico_retry`  COMMENT '再決済処理テーブル;';
--   *** ------------------------------------
--  *** ICO_SALES_HISTORY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `orico_sales_history`  COMMENT '予約売上テーブル履歴;';
--   *** ------------------------------------
--  *** ICO_WEBSERVICE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `orico_webservice`  COMMENT 'ウェブサービス用決済テーブル;';
--   *** ------------------------------------
--  *** A_HOTEL_RELATION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `ota_hotel_relation`  COMMENT 'OTA・BR間施設関連;OTAからのデータ取り込みを行った際に、OTA⇔BR間施設の関連付けを保持する';
--   *** ------------------------------------
--  *** A_PLAN_RELATION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `ota_plan_relation`  COMMENT 'OTA・BR間プラン関連;OTAからのデータ取り込みを行った際に、OTA⇔BR間のプランの関連付けを保持する';
--   *** ------------------------------------
--  *** A_ROOM_RELATION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `ota_room_relation`  COMMENT 'OTA・BR間部屋関連;OTAからのデータ取り込みを行った際に、OTA⇔BR間の部屋の関連付けを保持する';
--   *** ------------------------------------
--  *** RTNER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner`  COMMENT '提携先;';
--   *** ------------------------------------
--  *** RTNER_ACCOUNT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_account`  COMMENT '提携先アカウント;';
--   *** ------------------------------------
--  *** RTNER_BOOK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_book`  COMMENT '提携先実績テーブル;';
--   *** ------------------------------------
--  *** RTNER_BOOK_ACCOUNT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_book_account`  COMMENT 'ログイン認証;';
--   *** ------------------------------------
--  *** RTNER_BOOK_CUSTOMER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_book_customer`  COMMENT 'チャネル合算支払先情報;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_book_customer_dtl`  COMMENT 'チャネル別支払先情報;';
--   *** ------------------------------------
--  *** RTNER_BOOK_PARTNER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_book_partner`  COMMENT 'アカウント・パートナー（アフィリエイト）match;';
--   *** ------------------------------------
--  *** RTNER_CLOCK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_clock`  COMMENT '差分日時管理テーブル;';
--   *** ------------------------------------
--  *** RTNER_CLOUT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_clout`  COMMENT '提携先管理CLOUT用;';
--   *** ------------------------------------
--  *** RTNER_CLUTCH
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_clutch`  COMMENT '提携先管理CLUTCH用;CLUTCH用データ';
--   *** ------------------------------------
--  *** RTNER_CONTROL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_control`  COMMENT '提携先管理;';
--   *** ------------------------------------
--  *** RTNER_CUSTOMER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_customer`  COMMENT '精算先（提携先）;';
--   *** ------------------------------------
--  *** RTNER_CUSTOMER_SITE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_customer_site`  COMMENT '精算先関連サイト（提携先）;';
--   *** ------------------------------------
--  *** RTNER_DEFAULT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_default`  COMMENT '提携先デフォルト;宿泊条件の初期表示内容';
--   *** ------------------------------------
--  *** RTNER_DENY_KEYWORDS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_deny_keywords`  COMMENT '提携先別除外キーワード;キーワード辞書マスタに存在するキーワードを含むプランを除外します。';
--   *** ------------------------------------
--  *** RTNER_GROUP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_group`  COMMENT '提携先グループ;';
--   *** ------------------------------------
--  *** RTNER_GROUP_JOIN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_group_join`  COMMENT '提携先グループ関連;';
--   *** ------------------------------------
--  *** RTNER_INQUIRY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_inquiry`  COMMENT '提携先管理用INQUIRY;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_keyword_example`  COMMENT '提携先別キーワード;';
--   *** ------------------------------------
--  *** RTNER_LAYOUT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_layout`  COMMENT '提携先レイアウト;DASH、CLONEの外観のカスタマイズ項目';
--   *** ------------------------------------
--  *** RTNER_LAYOUT2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_layout2`  COMMENT '提携先レイアウト２;';
--   *** ------------------------------------
--  *** RTNER_LINKS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_links`  COMMENT '提携先リンク;';
--   *** ------------------------------------
--  *** RTNER_OAUTH2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_oauth2`  COMMENT 'Oauth管理テーブル;';
--   *** ------------------------------------
--  *** RTNER_OAUTH2_MEMBER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_oauth2_member`  COMMENT 'Oauth 会員テーブル;';
--   *** ------------------------------------
--  *** RTNER_OPENID
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_openid`  COMMENT 'OpenID管理テーブル;';
--   *** ------------------------------------
--  *** RTNER_OPENID_MEMBER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_openid_member`  COMMENT 'OpenID 会員テーブル;';
--   *** ------------------------------------
--  *** RTNER_POOL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_pool`  COMMENT '提携先（プール）;';
--   *** ------------------------------------
--  *** RTNER_POOL2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_pool2`  COMMENT '募集型企画旅行関係提携先情報;';
--   *** ------------------------------------
--  *** RTNER_SECTION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_section`  COMMENT '提携先所属団体リスト;';
--   *** ------------------------------------
--  *** RTNER_SITE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_site`  COMMENT '提携サイト;';
--   *** ------------------------------------
--  *** RTNER_SITE_RATE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_site_rate`  COMMENT '提携先サイト手数料率;';
--   *** ------------------------------------
--  *** RTNER_YDP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `partner_ydp`  COMMENT '日本旅行コーポレートプラン移行対応;';
--   *** ------------------------------------
--  *** YMENT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `payment`  COMMENT '入金情報;SMBCからの入金を登録する';
--   *** ------------------------------------
--  *** YMENT_MATCH
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `payment_match`  COMMENT '入金引当状態;入金引当状態を保存する';
--   *** ------------------------------------
--  DDL for Table PLAN
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_akf_relation`  COMMENT '日本旅行プラン関連（リロ）;';
--   *** ------------------------------------
--  *** AN_CANCEL_POLICY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_cancel_policy`  COMMENT 'プランキャンセルポリシー PLN155;';
--   *** ------------------------------------
--  *** AN_CANCEL_RATE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_cancel_rate`  COMMENT 'プランキャンセル料率 PLN154;';
--   *** ------------------------------------
--  *** AN_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_grants`  COMMENT 'プラン補助金設定情報;プラン毎の補助金利用制限を保持する';
--   *** ------------------------------------
--  *** AN_HOLD_KEYWORDS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_hold_keywords`  COMMENT 'プランに含まれるキーワード;プランにキーワード辞書マスタのキーワードが含まれているものを抽出';
--   *** ------------------------------------
--  *** AN_INFO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_info`  COMMENT 'プラン特色 PLN143;';
--   *** ------------------------------------
--  *** AN_JR
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_jr`  COMMENT 'プラン情報（JRセットプラン）;JRセットプラン専用プラン情報';
--   *** ------------------------------------
--  *** AN_MEDIA
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_media`  COMMENT 'プランメディア PLN144;';
--   *** ------------------------------------
--  *** AN_PARTNER_GROUP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_partner_group`  COMMENT 'プラン提携先グループ;';
--   *** ------------------------------------
--  *** AN_POINT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_point`  COMMENT 'プランポイント設定情報 PLN157;';
--   *** ------------------------------------
--  *** AN_POINT_20170101
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_point_20170101`  COMMENT 'プランポイント設定情報_20170101_ポイント率改定用;20170101からの施設ポイント負担率改定用のテーブル';
--   *** ------------------------------------
--  *** AN_SPEC
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_spec`  COMMENT 'プランスペック PLN142;';
--   *** ------------------------------------
--  *** AN_STATUS_POOL2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_status_pool2`  COMMENT 'プラン審査状態;募集型企画旅行プランの最新の審査状況';
--   *** ------------------------------------
--  *** AN_TABLE
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_tyk`  COMMENT '東横インプラン関連付けテーブル;';
--   *** ------------------------------------
--  *** AN_YDK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `plan_ydk`  COMMENT '宿研部屋関連付けテーブル;';
--   *** ------------------------------------
--  *** INT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `point`  COMMENT 'ポイント付与テーブル;';
--   *** ------------------------------------
--  *** INT_BONUS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `point_bonus`  COMMENT '宿泊ボーナスポイント管理;';
--   *** ------------------------------------
--  *** INT_CAMP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `point_camp`  COMMENT 'ポイントキャンペーン;ポイントキャンペーン用マスタテーブル';
--   *** ------------------------------------
--  *** INT_CAMP_ORDER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `point_camp_order`  COMMENT 'ポイント還元キャンペーン応募;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `point_camp_winning_rsv`  COMMENT 'ポイントキャンペーン当選予約情報;ポイントキャンペーンで予約単位で当選対象を決定する場合に使用';
--   *** ------------------------------------
--  *** EVENT_ACCESSES
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `prevent_accesses`  COMMENT '重複アクセス防止;ダブルクリックなどで処理が重なることを防止するテーブル';
--   *** ------------------------------------
--  *** NKING_HOTEL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `ranking_hotel`  COMMENT 'ホテル管理画面ランキング;';
--   *** ------------------------------------
--  *** CEIPT_POWER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `receipt_power`  COMMENT 'パワー入金テーブル;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `record_hotel_plan_count`  COMMENT '施設別プラン登録数;';
--   *** ------------------------------------
--  *** CORD_HOTEL_RESERVE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `record_hotel_reserve`  COMMENT '日次集計（ホテル泊数）;';
--   *** ------------------------------------
--  *** CORD_HOTEL_VIEW
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `record_hotel_view`  COMMENT '日次集計（ホテルビュー数）;';
--   *** ------------------------------------
--  *** CORD_MOBILE_RESERVE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `record_mobile_reserve`  COMMENT '日次集計モバイル（泊数）;';
--   *** ------------------------------------
--  *** CORD_MOBILE_VARIOUS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `record_mobile_various`  COMMENT '日次集計モバイル（その他）;';
--   *** ------------------------------------
--  *** CORD_RESERVE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `record_reserve`  COMMENT '日次集計（泊数）;';
--   *** ------------------------------------
--  *** CORD_RESERVE2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `record_reserve2`  COMMENT '	日次集計（泊数２）;';
--   *** ------------------------------------
--  *** CORD_VARIOUS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `record_various`  COMMENT '日次集計（その他）;';
--   *** ------------------------------------
--  *** PORT_GENDER_AGE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `report_gender_age`  COMMENT '年齢・男女別集計表;予泊数集計表にも使用';
--   *** ------------------------------------
--  *** PORT_LEAD_TIME
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `report_lead_time`  COMMENT 'リードタイム集計表;';
--   *** ------------------------------------
--  *** PORT_PLAN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `report_plan`  COMMENT 'プラン別集計表;';
--   *** ------------------------------------
--  *** PORT_PLAN2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `report_plan2`  COMMENT 'プラン別集計表 SYS126;';
--   *** ------------------------------------
--  *** PORT_PREF
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `report_pref`  COMMENT '出身地集計表;';
--   *** ------------------------------------
--  *** PORT_WEEK_HOTEL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `report_week_hotel`  COMMENT '施設別曜日別平均単価集計表;';
--   *** ------------------------------------
--  *** PORT_WEEK_HOTEL2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `report_week_hotel2`  COMMENT '施設別曜日別平均単価集計表２;';
--   *** ------------------------------------
--  *** SERVE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve`  COMMENT '予約テーブル;';
--   *** ------------------------------------
--  *** SERVE_ADDED_GOTO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_added_goto`  COMMENT 'GOTO後付対象予約;GoTo後付対象の予約に対して作られるレコード';
--   *** ------------------------------------
--  *** SERVE_ADDED_MESSAGE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_added_message`  COMMENT '予約追加メッセージ;BRからの予約への追加情報';
--   *** ------------------------------------
--  *** SERVE_AKAFU
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_akafu`  COMMENT '予約赤い風船部屋情報;';
--   *** ------------------------------------
--  *** SERVE_AUTHORI
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_authori`  COMMENT 'オーソリ状況;最後に行ったオーソリの内容を保持します。';
--   *** ------------------------------------
--  *** SERVE_AUTHORI_ZAP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_authori_zap`  COMMENT '旧オーソリ状況テーブル;';
--   *** ------------------------------------
--  *** SERVE_BASE_CHARGE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_base_charge`  COMMENT '予約時料金;';
--   *** ------------------------------------
--  *** SERVE_BASE_CHILD
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_base_child`  COMMENT '予約時子供人数情報;';
--   *** ------------------------------------
--  *** SERVE_BATH_TAX
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_bath_tax`  COMMENT '予約時入湯税;';
--   *** ------------------------------------
--  *** SERVE_CAMP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_camp`  COMMENT '予約キャンペーン情報;予約時のキャンペーン情報を保持';
--   *** ------------------------------------
--  *** SERVE_CANCEL_POLICY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_cancel_policy`  COMMENT '予約キャンセルポリシー;';
--   *** ------------------------------------
--  *** SERVE_CANCEL_RATE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_cancel_rate`  COMMENT '予約キャンセル料率;';
--   *** ------------------------------------
--  *** SERVE_CHARGE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_charge`  COMMENT '予約料金;';
--   *** ------------------------------------
--  *** SERVE_CHARGE_DETAIL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_charge_detail`  COMMENT '予約料金詳細（利用者タイプ別）;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_charge_discount`  COMMENT '予約割引料金;';
--   *** ------------------------------------
--  *** SERVE_CONTACT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_contact`  COMMENT '予約連絡先情報;予約完了メールの送信先電子メールアドレス';
--   *** ------------------------------------
--  *** SERVE_CREDIT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_credit`  COMMENT 'クレジットカード決済オーソリ;';
--   *** ------------------------------------
--  *** SERVE_CREDIT_DEV
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_credit_fluctuate`  COMMENT '増減額オーソリテーブル;';
--   *** ------------------------------------
--  *** SERVE_DISPOSE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_dispose`  COMMENT '赤伝票;';
--   *** ------------------------------------
--  *** SERVE_DISPOSE_9XG
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_dispose_9xg`  COMMENT '赤伝票_テスト用;赤伝票本番テスト用';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_dispose_grants`  COMMENT '赤伝票補助金;補助金用赤伝票';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_dispose_grants_9xg`  COMMENT '赤伝票補助金_テスト;';
--   *** ------------------------------------
--  *** SERVE_DISPOSE_RSV
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_dispose_rsv`  COMMENT '赤伝票リザーブ;ＢＲポイント割引料金';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_dispose_rsv_9xg`  COMMENT '赤伝票リザーブ_テスト用;赤伝票リザーブ本番テスト用';
--   *** ------------------------------------
--  *** SERVE_DISPOSE_YAHOO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_dispose_yahoo`  COMMENT '赤伝票ヤフー;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_dispose_yahoo_9xg`  COMMENT '赤伝票ヤフー_テスト用;赤伝票ヤフー本番テスト用';
--   *** ------------------------------------
--  *** SERVE_EXTENSION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_extension`  COMMENT '予約付随情報;';
--   *** ------------------------------------
--  *** SERVE_FIX
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_fix`  COMMENT '予約確定テーブル;';
--   *** ------------------------------------
--  *** SERVE_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_grants`  COMMENT '予約補助金情報;福利厚生補助で予約した予約CDと補助金情報登録';
--   *** ------------------------------------
--  *** SERVE_GUEST
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_guest`  COMMENT '予約宿泊者情報テーブル;';
--   *** ------------------------------------
--  *** SERVE_HOTEL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_hotel`  COMMENT '予約時施設情報;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_insurance_weather`  COMMENT 'お天気保険料金;';
--   *** ------------------------------------
--  *** SERVE_JR
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_jr`  COMMENT 'JRコレクション予約情報;';
--   *** ------------------------------------
--  *** SERVE_JWEST
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_jwest`  COMMENT 'JRおでかけネット予約情報;';
--   *** ------------------------------------
--  *** SERVE_MATERIAL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_material`  COMMENT '予約確定材料;';
--   *** ------------------------------------
--  *** SERVE_MESSAGE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_message`  COMMENT '予約メッセージ;予約に対してシステム・スタッフ・施設からのメッセージ';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_modify_history`  COMMENT '予約情報変更;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_modify_rizapuli`  COMMENT '予約情報変更（リザプリ）;リザプリ通知用予約情報変更格納TBL';
--   *** ------------------------------------
--  *** SERVE_PLAN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_plan`  COMMENT '予約プラン情報;';
--   *** ------------------------------------
--  *** SERVE_PLAN_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_plan_grants`  COMMENT '予約時の補助金設定情報;';
--   *** ------------------------------------
--  *** SERVE_PLAN_INFO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_plan_info`  COMMENT '予約プラン特色;';
--   *** ------------------------------------
--  *** SERVE_PLAN_JR
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_plan_jr`  COMMENT 'JRコレクションプラン情報;';
--   *** ------------------------------------
--  *** SERVE_PLAN_POINT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_plan_point`  COMMENT '予約時のポイント設定情報;plan_pointのスナップショット';
--   *** ------------------------------------
--  *** SERVE_PLAN_SPEC
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_plan_spec`  COMMENT '予約プランスペック;マスタの内容が変わった時に予約後のデータも変更される';
--   *** ------------------------------------
--  *** SERVE_POINT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_point`  COMMENT '予約時のポイント設定情報;';
--   *** ------------------------------------
--  *** SERVE_POWER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_power`  COMMENT 'パワーオーソリ状況;最後に行ったオーソリの内容を保持します。';
--   *** ------------------------------------
--  *** SERVE_POWER_DEV
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_receipt`  COMMENT '領収書表示状態;';
--   *** ------------------------------------
--  *** SERVE_TICKET
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_ticket`  COMMENT '金券使用テーブル;';
--   *** ------------------------------------
--  *** SERVE_TOUR
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_tour`  COMMENT '予約情報（募集型企画旅行）;';
--   *** ------------------------------------
--  *** SERVE_TRACE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_trace`  COMMENT '予約トレース;';
--   *** ------------------------------------
--  *** SERVE_VERIFY_YDP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_verify_ydp`  COMMENT '日本旅行 予約突合せ;';
--   *** ------------------------------------
--  *** SERVE_YDP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_ydp`  COMMENT '日本旅行 予約情報;';
--   *** ------------------------------------
--  *** SERVE_YDP_RECEIVE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `reserve_ydp_receive`  COMMENT '日本旅行 予約情報(受信);';
--   *** ------------------------------------
--  DDL for Table ROOM
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room2`  COMMENT '部屋 PLN100;';
--   *** ------------------------------------
--  *** OM_AKAFU
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_akafu`  COMMENT '赤い風船部屋情報;';
--   *** ------------------------------------
--  *** OM_AKAFU_RELATION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_akafu_relation`  COMMENT '赤い風船部屋関連;';
--   *** ------------------------------------
--  *** OM_AKF
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge`  COMMENT '部屋料金情報;';
--   *** ------------------------------------
--  *** OM_CHARGE_EARLY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_early`  COMMENT '部屋料金早割料金情報;早割料金があるときのみデータが存在';
--   *** ------------------------------------
--  *** OM_CHARGE_INITIAL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_initial`  COMMENT 'プラン料金希望情報;プラン料金の基本情報を保持します。';
--   *** ------------------------------------
--  *** OM_CHARGE_REMOVED
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_removed`  COMMENT '料金削除情報;';
--   *** ------------------------------------
--  *** OM_CHARGE_TODAY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_today`  COMMENT '部屋料金当日料金情報;当日販売料金があるときのみデータが存在';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_yho_bat_tmp`  COMMENT '部屋料金情報【旧】Yahoo Batch Temp;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_yho_bat_tmp_1`  COMMENT 'Yahoo差分料金用テンポラリテーブル1;Yahoo 差分料金のバッチ専用テンポラリテーブル1　実行のたびにtruncateされます';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_yho_bat_tmp_10`  COMMENT 'Yahoo差分料金用テンポラリテーブル10;Yahoo 差分料金のバッチ専用テンポラリテーブル10　実行のたびにtruncateされます';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_yho_bat_tmp_2`  COMMENT 'Yahoo差分料金用テンポラリテーブル2;Yahoo 差分料金のバッチ専用テンポラリテーブル2　実行のたびにtruncateされます';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_yho_bat_tmp_3`  COMMENT 'Yahoo差分料金用テンポラリテーブル3;Yahoo 差分料金のバッチ専用テンポラリテーブル3　実行のたびにtruncateされます';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_yho_bat_tmp_4`  COMMENT 'Yahoo差分料金用テンポラリテーブル4;Yahoo 差分料金のバッチ専用テンポラリテーブル4　実行のたびにtruncateされます';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_yho_bat_tmp_5`  COMMENT 'Yahoo差分料金用テンポラリテーブル5;Yahoo 差分料金のバッチ専用テンポラリテーブル5　実行のたびにtruncateされます';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_yho_bat_tmp_6`  COMMENT 'Yahoo差分料金用テンポラリテーブル6;Yahoo 差分料金のバッチ専用テンポラリテーブル6　実行のたびにtruncateされます';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_yho_bat_tmp_7`  COMMENT 'Yahoo差分料金用テンポラリテーブル7;Yahoo 差分料金のバッチ専用テンポラリテーブル7　実行のたびにtruncateされます';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_yho_bat_tmp_8`  COMMENT 'Yahoo差分料金用テンポラリテーブル8;Yahoo 差分料金のバッチ専用テンポラリテーブル8　実行のたびにtruncateされます';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_charge_yho_bat_tmp_9`  COMMENT 'Yahoo差分料金用テンポラリテーブル9;Yahoo 差分料金のバッチ専用テンポラリテーブル9　実行のたびにtruncateされます';
--   *** ------------------------------------
--  *** OM_COUNT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_count`  COMMENT '在庫数;';
--   *** ------------------------------------
--  *** OM_COUNT2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_count2`  COMMENT '在庫数 PLN104;';
--   *** ------------------------------------
--  *** OM_COUNT_AKAFU
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_count_akafu`  COMMENT '赤い風船在庫情報;';
--   *** ------------------------------------
--  *** OM_COUNT_INITIAL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_count_initial`  COMMENT '部屋数希望情報;部屋数の基本情報を保持します。';
--   *** ------------------------------------
--  *** OM_COUNT_INITIAL2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_count_initial2`  COMMENT '部屋数希望情報 PLN103;';
--   *** ------------------------------------
--  *** OM_COUNT_REMOVED
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_count_removed`  COMMENT '在庫削除情報;';
--   *** ------------------------------------
--  *** OM_JR
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_jr`  COMMENT '部屋情報（JRセットプラン）;部屋情報（JRセットプラン）';
--   *** ------------------------------------
--  *** OM_LEGACY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_legacy`  COMMENT '旧部屋コード;';
--   *** ------------------------------------
--  *** OM_MEDIA
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_media`  COMMENT '部屋メディア;';
--   *** ------------------------------------
--  *** OM_MEDIA2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_media2`  COMMENT '部屋メディア PLN106;';
--   *** ------------------------------------
--  *** OM_NETWORK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_network`  COMMENT '部屋ネットワーク環境;';
--   *** ------------------------------------
--  *** OM_NETWORK2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_network2`  COMMENT '部屋ネットワーク環境 PLN102;';
--   *** ------------------------------------
--  *** OM_NTA_RELATION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_nta_relation`  COMMENT '日本旅行部屋関連（リロ）;';
--   *** ------------------------------------
--  *** OM_PLAN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan`  COMMENT 'プラン;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_cancel_policy`  COMMENT 'プランキャンセルポリシー;クレジットカード決済の場合のキャンセルポリシー';
--   *** ------------------------------------
--  *** OM_PLAN_CANCEL_RATE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_cancel_rate`  COMMENT 'プランキャンセル料率;クレジットカード決済の場合のキャンセルポリシー';
--   *** ------------------------------------
--  *** OM_PLAN_CAPACITY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_capacity`  COMMENT '部屋プラン利用人数;';
--   *** ------------------------------------
--  *** OM_PLAN_CHILD
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_child`  COMMENT '子供人数情報;';
--   *** ------------------------------------
--  *** OM_PLAN_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_grants`  COMMENT 'プラン補助金設定情報【旧】;プラン毎の補助金利用制限を保持する';
--   *** ------------------------------------
--  *** OM_PLAN_INFO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_info`  COMMENT 'プラン特色;';
--   *** ------------------------------------
--  *** OM_PLAN_LEGACY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_legacy`  COMMENT '旧プランコード;';
--   *** ------------------------------------
--  *** OM_PLAN_LOWEST
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_lowest`  COMMENT 'プラン最安値;';
--   *** ------------------------------------
--  *** OM_PLAN_LOWEST2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_lowest2`  COMMENT 'プラン最安値;';
--   *** ------------------------------------
--  *** OM_PLAN_MATCH
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_match`  COMMENT '部屋プランマッチ;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_match_removed`  COMMENT 'プラン部屋の付け替え情報;';
--   *** ------------------------------------
--  *** OM_PLAN_MEDIA
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_media`  COMMENT 'プランメディア;';
--   *** ------------------------------------
--  *** OM_PLAN_NEW
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_new`  COMMENT 'プランNEWマーク表示制御情報;プラン内で最も小さい販売開始年月日から１４日後までプランNewマークを表示する。';
--   *** ------------------------------------
--  *** OM_PLAN_POINT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_point`  COMMENT 'プランポイント設定情報;ポイント利用条件設定';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_point_20170101`  COMMENT 'プランポイント【旧】_20170101_ポイント率改定用;20170101からの施設ポイント負担率改定用のテーブル(旧管理用)';
--   *** ------------------------------------
--  *** OM_PLAN_PRIORITY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_priority`  COMMENT '重点表示部屋プラン;重点表示プランを保持します。';
--   *** ------------------------------------
--  *** OM_PLAN_RANKING
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_ranking`  COMMENT '部屋プラン売れ筋ランキング;空室検索結果の表示順序決定に使用する値を保持します。';
--   *** ------------------------------------
--  *** OM_PLAN_RANKING2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_ranking2`  COMMENT '部屋プラン売れ筋ランキング PLN151;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_ranking_base`  COMMENT '部屋プラン売れ筋ランキング調整;部屋プラン売れ筋ランキングを調整するためのデータを保持します。';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_ranking_base2`  COMMENT '部屋プラン売れ筋ランキング調整 PLN152;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_ranking_calc`  COMMENT '部屋プラン売れ筋計算;売れ筋係数を計算するための値を保持します。';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_ranking_calc2`  COMMENT '部屋プラン売れ筋計算 PLN153;';
--   *** ------------------------------------
--  *** OM_PLAN_REMOVED
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_removed`  COMMENT 'プラン削除情報;';
--   *** ------------------------------------
--  *** OM_PLAN_SPEC
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_spec`  COMMENT 'プランスペック;';
--   *** ------------------------------------
--  *** OM_PLAN_YAHOO_POINT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_yahoo_point`  COMMENT 'プランYahooポイント（room_plan_pointへ;ヤフーポイントプラン room_plan_pointへ移行予定';
--   *** ------------------------------------
--  *** OM_PLAN_YDP2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_plan_ydp2`  COMMENT '日本旅行プラン移行対応;';
--   *** ------------------------------------
--  *** OM_SPEC
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_spec`  COMMENT '部屋スペック;';
--   *** ------------------------------------
--  *** OM_SPEC2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_spec2`  COMMENT '部屋スペック PLN101;';
--   *** ------------------------------------
--  *** OM_TYK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_tyk`  COMMENT '東横イン部屋関連付けテーブル;';
--   *** ------------------------------------
--  *** OM_YDK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_ydk`  COMMENT '宿研部屋関連付けテーブル;';
--   *** ------------------------------------
--  *** OM_YDP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_ydp`  COMMENT '日本旅行 部屋関連付け;';
--   *** ------------------------------------
--  *** OM_YDP2
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `room_ydp2`  COMMENT '日本旅行部屋移行対応;';
--   *** ------------------------------------
--  *** UTE_MAP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `route_map`  COMMENT '路線図;';
--   *** ------------------------------------
--  *** V_PUSH_AREAS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `rsv_push_areas`  COMMENT 'プッシュエリア;新UI エリア指定検索用  デフォルト表示分は必ず登録（掲載開始年月日ヌル値）';
--   *** ------------------------------------
--  *** V_TOP_CONTENTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `rsv_top_contents`  COMMENT 'ベストリザーブトップページ（ 広告・キャンペーン）;新UI用';
--   *** ------------------------------------
--  *** CURE_LICENSE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `secure_license`  COMMENT 'セキュア認可;';
--   *** ------------------------------------
--  *** ND_MAIL_QUEUE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `send_mail_queue`  COMMENT '送信電子メールキュー;';
--   *** ------------------------------------
--  *** RVICE_HUNTING
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `service_hunting`  COMMENT 'ホテルを探してポイントゲット管理テーブル;';
--   *** ------------------------------------
--  *** RVICE_VOTE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `service_vote`  COMMENT '大投票 設問データ;';
--   *** ------------------------------------
--  *** RVICE_VOTE_ANSWER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `service_vote_answer`  COMMENT '大投票 設問回答;';
--   *** ------------------------------------
--  *** RVICE_VOTE_CHOICES
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `service_vote_choices`  COMMENT '大投票 設問選択肢;';
--   *** ------------------------------------
--  *** Y_AREA
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `spot_group`  COMMENT 'スポットグループ;';
--   *** ------------------------------------
--  *** OT_GROUP_MATCH
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `spot_group_match`  COMMENT 'スポットグループマッチ;';
--   *** ------------------------------------
--  *** OT_NEARBY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `spot_nearby`  COMMENT 'スポット近隣のスポット;';
--   *** ------------------------------------
--  *** O_COMPARE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `sso_compare`  COMMENT 'SSO照合;';
--   *** ------------------------------------
--  *** AFF
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `staff`  COMMENT 'スタッフ;';
--   *** ------------------------------------
--  *** AFF_ACCOUNT
--   *** ------------------------------------
...
(
	`staff_id` INT AUTO_INCREMENT COMMENT '1;スタッフID;', 
...
ALTER TABLE `staff_account` COMMENT 'スタッフ認証;';
--   *** ------------------------------------
--  *** AT_TABLE
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `stock_power`  COMMENT 'パワー仕入れテーブル;';
--   *** ------------------------------------
--  *** BMIT_FORM_CHECK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `submit_form_check`  COMMENT '重複実行チェック;';
--   *** ------------------------------------
--  *** MP_GROUP_RESERVE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `temp_group_reserve`  COMMENT '団体予約;旧GRP_RESERVE_DATA';
--   *** ------------------------------------
--  *** MP_HOTEL_VS_MTN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `temp_hotel_vs_mtn`  COMMENT '施設賛同;管理サイトの対楽天対応での賛同状態を保存。2006年01月の請求データ作成まで有効。';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `temp_kei_month_discount`  COMMENT '送客請求割引明細;';
--   *** ------------------------------------
--  *** MP_YAHOO_POINT_BOOK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `temp_yahoo_point_book`  COMMENT 'ポイント台帳仮;';
--   *** ------------------------------------
--  *** P_ATTENTION
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `top_attention`  COMMENT 'ベストリザーブトップページ（注目表示）;ベストリザーブトップページの注目に表示する項目を管理する。';
--   *** ------------------------------------
--  *** P_ATTENTION_DETAIL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `top_attention_detail`  COMMENT 'ベストリザーブトップページ（注目表示詳細）;ベストリザーブトップページに表示する注目の詳細を保持する。';
--   *** ------------------------------------
--  *** ITTER
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `twitter`  COMMENT '情報メッセージ;';
--   *** ------------------------------------
--  *** RIFY_YAHOO_POINT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `verify_yahoo_point`  COMMENT 'ベリファイYahooポイント;';
--   *** ------------------------------------
--  *** ICE_REPLY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `voice_reply`  COMMENT '宿泊体験返答;';
--   *** ------------------------------------
--  *** ICE_REVIEW
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `voice_review`  COMMENT 'クチコミ評点;';
--   *** ------------------------------------
--  *** ICE_STAY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `voice_stay`  COMMENT '宿泊体験;';
--   *** ------------------------------------
--  *** ATHER_AREA_CITY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `weather_area_city`  COMMENT '天気予報地域対応表;';
--   *** ------------------------------------
--  *** LFARE_DEST_HISTORY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `welfare_dest_history`  COMMENT '福利厚生割引対象目的地履歴;補助金情報更新処理で更新前の補助金情報目的地を管理するテーブル';
--   *** ------------------------------------
--  *** LFARE_GRANTS
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `welfare_grants`  COMMENT '福利厚生補助金情報;最新の補助金情報を管理するテーブル';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `welfare_grants_history`  COMMENT '福利厚生補助金情報履歴;補助金情報更新処理で更新前の補助金情報を管理するテーブル';
--   *** ------------------------------------
--  *** LFARE_MATCH
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `welfare_match`  COMMENT '福利厚生補助金_マッチング情報;補助金と、会員の紐付';
--   *** ------------------------------------
--  *** LFARE_MATCH_HISTORY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `welfare_match_history`  COMMENT '福利厚生補助金_マッチング情報履歴;紐付更新処理で更新前の各補助金情報と紐づく会員ランクの情報を管理するテーブル';
--   *** ------------------------------------
--  *** LFARE_OP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `welfare_op`  COMMENT '福利厚生補助金情報操作;画面からの更新履歴';
--   *** ------------------------------------
--  *** LFARE_OP_HISTORY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `welfare_op_history`  COMMENT '福利厚生補助金情報操作履歴;補助金の操作履歴';
--   *** ------------------------------------
--  *** LFARE_RANK_HISTORY
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `welfare_rank_history`  COMMENT '福利厚生補助金_ランク情報履歴;紐づく会員ランクの情報を管理するテーブル';
--   *** ------------------------------------
--  *** _ROOM_PLAN_SALES
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `wk_room_plan_sales`  COMMENT '販売部屋プラン;';
--   *** ------------------------------------
--  *** HOO_POINT_BOOK
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `yahoo_point_book`  COMMENT 'ヤフーポイント台帳;確定済みのYahooポイント';
--   *** ------------------------------------
--  *** HOO_POINT_BOOK_PRE
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `yahoo_point_book_pre`  COMMENT 'ヤフーポイント仮台帳;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `yahoo_point_cancel_queue`  COMMENT 'ヤフーポイントキャンセルキュー;施設・スタッフがキャンセル操作した分の';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `yahoo_point_plus_hotel`  COMMENT 'ヤフーポイント加算対象施設;';
--   *** ------------------------------------
--  *** HOO_POINT_PLUS_INFO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `yahoo_point_plus_info`  COMMENT 'ヤフーポイント加算情報;施設様設定の付与ポイント率に対しBR側で加算するポイント率の履歴情報';
--   *** ------------------------------------
--  *** HOO_POINT_PLUS_PLAN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `yahoo_point_plus_plan`  COMMENT 'ヤフーポイント加算対象プラン;';
--   *** ------------------------------------
--  *** P_BASE_TIME
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `ydp_base_time`  COMMENT '外部連携基準時間;fd_base_timeからydp_base_timeにテーブル名変更';
--   *** ------------------------------------
--  *** P_ITEM
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `ydp_item`  COMMENT '外部連携コードマスタ;';
--   *** ------------------------------------
--  *** P_ITEM_CONTROL
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `ydp_item_control`  COMMENT '外部連携項目設定マスタ;';
--   *** ------------------------------------
--  *** KON
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `zap_member_epark`  COMMENT 'EPARK会員CD中間テーブル;BR会員とEPARK会員連携状態を保持する';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `zap_member_epark_history`  COMMENT 'EPARK会員CD中間テーブル	履歴;BR会員とEPARK会員連携状態の履歴を保持する';
--   *** ------------------------------------
--  *** P_MEMBER_YAHOO
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `zap_member_yahoo`  COMMENT 'Yahoo会員CD中間テーブル;BBAuth会員CDとYconnect会員CD紐付テーブル';
--   *** ------------------------------------
--  *** P_MSC
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `zap_msc`  COMMENT 'MSC処理時間計測;';
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `zap_plan_partner_group`  COMMENT 'プラン提携先グループ【旧】;';
--   *** ------------------------------------
--  *** P_PLAN_POINT
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `zap_plan_point`  COMMENT 'プランポイント設定情報（当社ゼロポイント負担対応用）;';
--   *** ------------------------------------
--  *** P_RAKUJAN
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `zap_rakujan`  COMMENT 'らくじゃん速度計測;';
--   *** ------------------------------------
--  *** P_RESERVE_SP
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `zap_reserve_sp`  COMMENT 'スマートフォン予約リスト;reserve_system への対応が終わるまでの暫定テーブルです。';
--   *** ------------------------------------
--  *** P_ROOM
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `zap_room`  COMMENT '部屋作成テーブル;';
--   *** ------------------------------------
--  *** P_ROOM_CHARGE
--   *** ------------------------------------
...
--   *** ------------------------------------
  ...
  ;
   ...
   ALTER TABLE `zap_room_plan`  COMMENT 'プラン作成テーブル;';
--   *** ------------------------------------
--  *** P_ROOM_PLAN_CHARGE
--   *** ------------------------------------
