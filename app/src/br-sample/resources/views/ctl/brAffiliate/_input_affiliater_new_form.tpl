    ...
    <tr>
      ...
      <td nowrap><input type="text" name="affiliater[affiliater_nm]" value="{$v->helper->form->strip_tags($v->assign->affiliater_value.affiliater_nm)}" size="80" maxlength="64" ></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td nowrap><input type="text" name="affiliater[open_ymd]" value="{$v->helper->form->strip_tags($v->assign->affiliater_value.open_ymd)|date_format:"%Y%m%d"}" size="10" maxlength="10">　<small>YYYY/MM/DD <small>又は</small> YYYY-MM-DD</small></td>
    </tr>
    <tr>