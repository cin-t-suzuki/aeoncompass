...
<table border="1" cellspacing="0" cellpadding="3">
    ...
    <tr>
      ...
      <td>
        ...
        @foreach ($notify_device as $value)
          @if ($device_first != true)+@endif
          @if ($value == 1)ファックス@php $device_first = false @endphp
          @elseif ($value == 2)電子メール@php $device_first = false @endphp
          @elseif ($value == 4)オペレータ連絡@php $device_first = false @endphp
          @elseif ($value == 8)リンカーン@php $device_first = false @endphp
          @endif
        @endforeach
        <br>
      </td>
    ...
    <tr>
      ...
      <td>
        @if ($hotel_control->akafu_status == 1)利用する
        @else 利用しない
        @endif
      </td>
    </tr>
