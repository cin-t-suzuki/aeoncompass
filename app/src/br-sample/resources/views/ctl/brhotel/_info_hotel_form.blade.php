...
<table border="1" cellspacing="0" cellpadding="3">
	...
	<tr>
		...
		<td>
			@if(isset($a_mast_pref['pref_nm'])){{strip_tags($a_mast_pref['pref_nm'])}}@endif
			@if(isset($a_mast_city['city_nm'])){{strip_tags($a_mast_city['city_nm'])}}@endif
			@if(isset($a_mast_ward['ward_nm'])){{strip_tags($a_mast_ward['ward_nm'])}}@endif
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<pre>{{strip_tags($hotel['check_in_info'])}}</pre><br>
		</td>
	</tr>
