...
<table border="1" cellspacing="0" cellpadding="3">
    ...
    <tr>
      ...
      <td>
        ...
        {else}
          <span nowrap style="float: left;">**********</span><span nowrap style="float: right;"><a href="{$v->env.source_path}{$v->env.module}/brhotel/seeingnotes/target_cd/{$v->helper->form->strip_tags($v->assign->target_cd)}">施設ログインパスワードの閲覧</a></span>
        {/if}
      </td>
      <td><small>10文字<font color="#0000ff">（必須）</font></small></td>
    </tr>
    ...
    <tr>
      ...
      {/if}
      <td><small>施設(買取以外)の料率情報が存在していない場合、公開中は選択できません。</small></td>
    </tr>
