...
<tr>
	...
	<select size="1" name="Hotel[pref_id]">
		@foreach ($mast_prefs['values'] as $mast_pref)
			...
			@if ($mast_pref['pref_id'] == $hotel['pref_id'])
				selected
			@endif>
			{{strip_tags($mast_pref['pref_nm'])}}</option>
		@endforeach
	</select>
	...
	<td><small>選択</small><br><small><font color="#339933">都道府県、市、区</font><font color="#0000ff">（都道府県、市必須）</font></small></td>
</tr>
