...
<table border="1" cellspacing="0" cellpadding="3">
    ...
    <tr>
      ...
      <td>
        <span nowrap style="float: left;">**********</span>　<span nowrap style="text-align: right;"><a href="{$v->env.source_path}{$v->env.module}/brhotel/seeingnotes/target_cd/{$v->helper->form->strip_tags($v->assign->target_cd)}">施設ログインパスワードの閲覧</a></span>
      </td>
    </tr>
