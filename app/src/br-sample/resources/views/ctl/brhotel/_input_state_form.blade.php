...
<table border="1" cellspacing="0" cellpadding="3">
    ...
    <tr>
        ...
        <td>
            <label>
                <input type="radio" name="Hotel_Notify[neppan_status]" value="1" {{ $hotel_notify->neppan_status === '1' ? 'checked' : '' }} />
                通知する
            </label>

            <label>
                <input type="radio" name="Hotel_Notify[neppan_status]" value="0" {{ $hotel_notify->neppan_status === '0' ? 'checked' : '' }} />
                通知しない
            </label>

            {{-- MEMO: 移植元は is_empty --}}
            <label>
                <input type="radio" name="Hotel_Notify[neppan_status]" value="" {{ is_null($hotel_notify->neppan_status) ? 'checked' : '' }} />
    ...
    <tr>
        ...
        <td>
            {{-- MEMO: 移植元は is_empty --}}
            <input type="radio" name="Hotel_Notify[notify_status]" value="1" {{ $hotel_notify->notify_status == 1 || is_null($hotel_notify->notify_status) ? 'checked' : '' }} id="j4">
            <label for="j4">通知する</label>

            {{-- MEMO: 移植元は is_empty --}}
            <input type="radio" name="Hotel_Notify[notify_status]" value="0" {{ $hotel_notify->notify_status == 0 && !is_null($hotel_notify->notify_status) ? 'checked' : '' }} id="j5">
    ...
    <tr>
        ...
        <td>
            {{-- MEMO: 移植元は is_empty --}}
            <input type="radio" name="Hotel_Notify[faxpr_status]" value="1" {{ $hotel_notify->faxpr_status == 1 || is_null($hotel_notify->faxpr_status) ? 'checked' : '' }} id="j9">
            <label for="j9">表示する</label>

            {{-- MEMO: 移植元は is_empty --}}
            <input type="radio" name="Hotel_Notify[faxpr_status]" value="0" {{ $hotel_notify->faxpr_status == 0 && !is_null($hotel_notify->faxpr_status) ? 'checked' : '' }} id="j8">
    ...
    <tr>
        ...
        <td>
            {{-- MEMO: 移植元は is_empty --}}
            <input type="radio" name="Hotel_Control[checksheet_send]" value="1" {{ $hotel_control->checksheet_send == 1 && !is_null($hotel_control->checksheet_send) ? 'checked' : '' }} id="i4">
            <label for="i4">送信する</label>

            {{-- MEMO: 移植元は is_empty --}}
            <input type="radio" name="Hotel_Control[checksheet_send]" value="0" {{ $hotel_control->checksheet_send == 0 || is_null($hotel_control->checksheet_send) ? 'checked' : '' }} id="i3">
    ...
    <tr>
        ...
        <td>
            {{-- MEMO: 移植元は is_empty --}}
            <input type="radio" name="Hotel_Control[charge_round]" value="1" {{ $hotel_control->charge_round == 1 || is_null($hotel_status->entry_status) ? 'checked' : '' }} id="i5">
            <label for="i5">1の位で丸める</label>

            <input type="radio" name="Hotel_Control[charge_round]" value="10" {{ $hotel_control->charge_round == 10 ? 'checked' : '' }} id="i6">
            <label for="i6">10の位で丸める</label>

            <input type="radio" name="Hotel_Control[charge_round]" value="100" {{ $hotel_control->charge_round == 100 ? 'checked' : '' }} id="i7">
    ...
    <tr>
        ...
        <td>
            <input type="radio" name="Hotel_Control[management_status]" value="1" {{ $hotel_control->management_status == 1 ? 'checked' : '' }} id="management_status1">
            <label for="management_status1">ファックス管理</label>

            {{-- MEMO: 移植元は is_empty --}}
            <input type="radio" name="Hotel_Control[management_status]" value="2" {{ $hotel_control->management_status == 2 || is_null($hotel_control->management_status) ? 'checked' : '' }} id="management_status2">
            <label for="management_status2">インターネット管理</label>

            <input type="radio" name="Hotel_Control[management_status]" value="3" {{ $hotel_control->management_status == 3 ? 'checked' : '' }} id="management_status3">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="radio" id="akafu_status_0" name="Hotel_Control[akafu_status]" value="0" {{ $hotel_control->akafu_status != 1 ? 'checked' : '' }} />
