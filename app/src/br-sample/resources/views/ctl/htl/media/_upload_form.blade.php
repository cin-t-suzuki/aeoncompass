...
{{-- <form action="{$v->env.source_path}{$v->env.module}/htlsmedia/upload/" method="post" enctype="multipart/form-data" id="upload_form"> --}}
    ...
    <table border="1" cellpadding="4" cellspacing="0" width="700">
        <tr>
            ...
            <td width="100%">
                <input id="inputFile" type="file" size="40" name="file" accept="image/jpeg,image/gif,image/pjpeg">
            </td>
        </tr>
        <tr>
            ...
            <td>
                <table border="0" cellpadding="4" cellspacing="1" width="100%">
                    ...
                    @if (\Route::CurrentRouteName() === 'ctl.htl.media.list' ||
                        ($form_params['label_cd']['map'] === '1' &&
                            ($form_params['label_cd']['outside'] !== '1' &&
                                $form_params['label_cd']['inside'] !== '1' &&
                                $form_params['label_cd']['room'] !== '1' &&
                                $form_params['label_cd']['other'] !== '1')))
                        <tr>
