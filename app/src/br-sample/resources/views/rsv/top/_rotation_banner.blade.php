...
<div id="jqs-slider" class=" pgc-600-sc slider-pro">
...
<div class="sp-slides">
  ...
  {if $smarty.now <  '2020-08-31 23:59:59'|strtotime}
  <div class="sp-slide">
  ...
  {/if}
    ...
    {if $smarty.now <= '2019-05-30 23:59:58'|strtotime}
    {* 【ポイント祭り】「EPARKトラベル」＆「ベストリザーブ・宿ぷらざ」連動企画！！ *}
    <div class="sp-slide">
...
<div class="sp-thumbnails">
  ...
  {if $smarty.now >= '2020-07-28 00:00:00'|strtotime}
  {if $smarty.now <  '2020-08-31 23:59:59'|strtotime}
  <img class="sp-thumbnail" src="{$v->env.path_img}/tpc/slider/2020-2-cp.gif"/>
  {/if}
  {/if}
  ...
  {/if}
    ...
    {if $smarty.now <= '2019-05-30 23:59:58'|strtotime}
    {* 【ポイント祭り】「EPARKトラベル」＆「ベストリザーブ・宿ぷらざ」連動企画！！*}
    <img class="sp-thumbnail" src="{$v->env.path_img}/tpc/slider/2019-1-cp.gif"/>
    {/if}
...
$( document ).ready(function( ) {
  ...
  $('.slider-pro').animate({opacity: '1'}, 1500);
