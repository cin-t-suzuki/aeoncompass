      ...
      <div id="contact_contents">
        ...
        <div class="section">
            ...
            <div id="stylized" class="myform">
                ...
                <p>「<a href="/reminder/ptm11/">会員コード・パスワードの照会</a>」フォームをご利用ください。照会できない場合は下記フォームへご登録の「氏名」「生年月日」「電話番号」を本文にご入力の上、お問い合わせください。会員様の特定ができましたら、ご登録のメールアドレスへ会員コード・パスワードをご案内させていただきます。</p>
                <label>&nbsp;</label>
