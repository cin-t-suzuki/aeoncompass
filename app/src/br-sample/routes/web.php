...
// サービス
Route::match(['get', 'post'], '/ctl/htlHotelService/list/', [\App\Http\Controllers\ctl\HtlHotelServiceController::class, 'list'])->name('ctl.htl_hotel_service.list');
Route::match(['get', 'post'], '/ctl/htlHotelService/create/', [\App\Http\Controllers\ctl\HtlHotelServiceController::class, 'create'])->name('ctl.htl_hotel_service.create');
