...
class BrhotelAdvert2009000400Controller extends _commonController
{
    ...
    public function list()
    {
        ...
        // 広告掲載施設の取得
        $hotel_adverts = $advertModel->getHotelAdvert2009000400s();
    ...
    public function create()
    {
        ...
        // 広告掲載 ID を取得
        $advertModel = new Advert();
        $n_record_id = $advertModel->getRecordId('Hotel_Advert_2009000400');
