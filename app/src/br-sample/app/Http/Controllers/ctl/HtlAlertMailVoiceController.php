...
use App\Http\Requests\HtlAlertMailvoiceRequest;
use Exception;

class HtlAlertMailVoiceController extends _commonController
{
    // 一覧
    public function list(Request $request)
    {
        ...
        try {
            // 宿泊体験通知メール情報取得
            $a_alert_mail_hotel = $this->getAlertMailHotels('voice', $target_cd);
            ...
            return view('ctl.htlalertmailvoice.list', [
                'target_cd'          => $target_cd,
    ...
    // 新規登録処理
    public function create(HtlAlertMailvoiceRequest $request)
    {
        ...
        try {
            ...
            if ($mail_check == true) {
                $o_alert_mail_hotel->create([
                    ...
                    'alert_system_cd' => 'voice',                                   // アラートシステムコード
                ...
                return redirect()
                    ->route('ctl.htl_alert_mail_voice.list', ['target_cd' => $target_cd])
                    ->with(['guides' => [$email . 'を登録しました。']]);
            } else {
                return redirect()
                    ->route('ctl.htl_alert_mail_voice.list', [
                        'target_cd' => $target_cd,
        ...
        try {
            ...
            if ($a_alert_mail_hotel_count == 0) {
                ...
                return redirect()
                    ...
                    ->with(['errors' => ['ご希望の宿泊体験通知メールデータが見つかりませんでした。下記一覧から選んでください。']]);
            }
            ...
            return redirect()
                ...
                ->with(['errors' => ['ご希望の宿泊体験通知メールデータを更新できませんでした。']]);
        }
    }
    ...
    public function delete(Request $request)
    {
        ...
        try {
            ...
            return redirect()
                ...
                ->with(['errors' => ['ご希望の宿泊体験通知メールデータを削除できませんでした。']]);
        }
    }
    ...
    public function emailValidator($target_cd, $a_attributes)
    {
        ...
        // アラートシステムコード
        $a_conditions['alert_system_cd'] = 'voice';
