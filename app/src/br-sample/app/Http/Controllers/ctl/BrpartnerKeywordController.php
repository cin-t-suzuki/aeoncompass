...
class BrpartnerKeywordController extends _commonController
{
    ...
    public function index()
    {
        ...
        $search_params = $partnerKeywordModel->searchParams($requestPartnerKeyword);
    ...
    public function sort()
    {
        ...
        $result1 = $this->sortList($requestPartnerKeyword['other_branch_no'], $requestPartnerKeyword['order_no']);
        $result2 = $this->sortList($requestPartnerKeyword['branch_no'], $requestPartnerKeyword['other_order_no']);
    ...
    // 更新する並べ替え対象の取得
    //======================================================================
    private function sortList($branch_no, $order_no)
    {
        // データを取得
        $requestPartnerKeyword = Request::all();
        $partnerKeywordModel = new PartnerKeyword();
    ...
    public function new()
    {
        ...
        $partnerKeywordModel = new PartnerKeyword();
        $display_status_selecter = $partnerKeywordModel->displayStatusSelecter();
        $search_params = $partnerKeywordModel->searchParams($requestPartnerKeyword);
    ...
    public function create()
    {
        ...
        // 初期化
        $a_partner_keyword_example_work = [];
        ...
        // 登録するデータを作成
        $n_bo = $partnerKeywordModel->countRecord($requestPartnerKeyword) + 1; // ※bo = branch_noとorder_noの略（同じ値を設定する為）
    ...
    public function edit()
    {
        ...
        // 初期化
        $partner_keyword_example_work = [];
        $partner_keyword_example_find = [];
