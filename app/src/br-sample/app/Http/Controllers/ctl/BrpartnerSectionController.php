...
class BrpartnerSectionController extends _commonController
{
    ...
    public function index()
    {
        ...
        $section_list = $partnerSectionModel->getSectionList($request_params); //引数追加
        $search_params = $partnerSectionModel->searchParams($request_params);
    ...
    public function new()
    {
        ...
        $partnerSectionModel = new PartnerSection();
        $search_params = $partnerSectionModel->searchParams($_a_request_params);
    ...
    public function create()
    {
        ...
        $partnerSectionModel = new PartnerSection();
        $search_params = $partnerSectionModel->searchParams($requestPartnerSection); //追記

        //画面にないデータを作成
        $requestPartnerSection['section_id'] = $partnerSectionModel->getSectionIdNext($requestPartnerSection);
        $requestPartnerSection['order_no'] = $partnerSectionModel->getOrderNoNext($requestPartnerSection);
    ...
    public function edit()
    {
        ...
        // 初期化
        $partner_section_work = [];
        $partner_section_find = [];
        ...
        // 編集内容の設定
        $requestPartnerSection['section_nm']
            = ($requestPartnerSection['section_nm'] ?? $partner_section_find['section_nm']);
...
SQL;
        ...
        //表示順の調整
        $order_result = $this->updateOrderNoSection($update_order_list);
        if (!$order_result) {
            $errorList[] = "所属団体情報の更新ができませんでした。";
            $this->addViewData("form_params", $requestPartnerSection); //入力値を戻す
            $this->addViewData("search_params", $search_params); //検索用パラメータ
    ...
    //////////////////////////////////////////////////////
    private function updateOrderNoSection($update_order_list)
    {
        $requestPartnerSection = Request::all();
        $partnerSectionModel = new PartnerSection();
...
SQL;
        ...
        //表示順の調整
        $this->updateOrderNoSection($update_order_list);
