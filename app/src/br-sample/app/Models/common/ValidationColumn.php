...
class ValidationColumn
{
    ...
    private $numberAndAlphabetCheck = false;  // 半角英数のみチェック
    ...
    public function isNotHalfKana()
    {
        return $this->notHalfKanaCheck;
    }
    ...
    public function isKanaOnly()
    {
        return $this->kanaOnlyCheck;
    }
    ...
    public function isHiraganaOnly()
    {
        return $this->hiraganaOnlyCheck;
    }
    ...
    public function isCurrencyOnly()
    {
        return $this->currencyOnlyCheck;
    }
    ...
    public function isRateOnly()
    {
        return $this->rateOnlyCheck;
    }
    ...
    public function isHyphenOrSlashDate()
    {
        return $this->hyphenOrSlashDateCheck;
    }
    ...
    public function isCheckInOutTime()
    {
        return $this->checkInOutTimeCheck;
    }
    ...
    public function isOriginalValidation()
    {
        return $this->originalValidation;
    }
    public function getOriginalValidFunc()
    {
    ...
    public function isNumberAndUpperAlphabet()
    {
        return $this->numberAndUpperAlphabetCheck;
    }

    /**
     * 半角英数のみであるかチェック only_number_and_alphabet
     */
    public function numberAndAlphabet()
    {
        $this->numberAndAlphabetCheck = true;
        return $this;
    }
    public function isNumberAndAlphabet()
    {
        return $this->numberAndAlphabetCheck;
    }
    ...
    public function isNotFullCharacter()
    {
        return $this->notFullCharacterCheck;
    }
}
