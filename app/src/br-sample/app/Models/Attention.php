...
class Attention extends CommonDBModel
{
     ...
     * コンストラクタ
     */
    public function __construct() //function→public functionでいいか？（phpcsエラー）
    {
...
SQL;
        ...
        if (!empty($a_check_date)) {
            $a_error_message['date_error']
                = $start_date_year . '年' . $start_date_month . '月' . $start_date_day . '日はすでに登録されています。';
        }
